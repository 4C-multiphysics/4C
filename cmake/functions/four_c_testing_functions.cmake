...
# Two-stage run from same input file and VTK comparison from the restarted run.
#
# Usage:
...
function(four_c_test_restarted_vtk)
  ...
  set(name_of_compare "${name_of_restart}-vtk_compare")
  if(FOUR_C_WITH_PYTHON)
    ...
    set(compare_cmd
        "${FOUR_C_PYTHON_VENV_BUILD}/bin/python ${PROJECT_SOURCE_DIR}/tests/output_test/vtk_compare.py ${result_dir} ${ref_path} ${_parsed_TOLERANCE} ${nsteps} ${steps_joined}"
        )
    _add_test_with_options(
      NAME_OF_TEST
      ${name_of_compare}
