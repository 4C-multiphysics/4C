    ...
    const std::string& function_name)
{
  ...
  Core::LinAlg::Matrix<3, 1> center(Core::LinAlg::Initialization::set_zero);
  ...
  // rotation matrix
  Core::LinAlg::Matrix<3, 3> rot(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 1> x_new(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1> rotated(Core::LinAlg::Initialization::set_zero);
...
// Safety checks
  ...
  if (robin_id >= 0)
  {
    ...
    if (sliplength != 0.0)
    {
      ...
      Core::LinAlg::Matrix<3, 1> tmp_itraction(Core::LinAlg::Initialization::set_zero);
  ...
  {
    Core::LinAlg::Matrix<3, 1> tmp_ivel(Core::LinAlg::Initialization::set_zero);
    ...
    std::vector<Core::LinAlg::SerialDenseMatrix>& solid_stress)
{
  ...
  {
    Core::LinAlg::Matrix<num_dim, 1> ei(Core::LinAlg::Initialization::set_zero);
    ei(i, 0) = 1.;
