...
Particle::SPHRigidParticleContactBase::SPHRigidParticleContactBase(
    ...
    : params_sph_(params),
      ...
      boundarytypes_({ParticleType::BoundaryPhase, ParticleType::RigidPhase})
{
  // empty constructor
}
    ...
    const std::shared_ptr<Particle::SPHNeighborPairs> neighborpairs)
{
  ...
  // safety check
  if (not boundarytypes_.contains(ParticleType::RigidPhase))
...
void Particle::SPHRigidParticleContactElastic::elastic_contact_particle_contribution()
{
  ...
  ConstParticleContainerBundleStatePtrs& vel =
      particlecontainerbundle_->try_get_ptrs_to_state(ParticleState::Velocity, boundarytypes_);
  ParticleContainerBundleStatePtrs& force =
      particlecontainerbundle_->try_get_ptrs_to_state_writable(
          ParticleState::Force, boundarytypes_);
