    ...
    Core::LinAlg::SerialDenseMatrix* elemat1_epetra)
{
  ...
  Core::LinAlg::Matrix<bdrynen_, 1> escaaf(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<bdrynen_, 1> epreaf(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseMatrix& elemat1, Core::LinAlg::SerialDenseVector& elevec1)
{
  ...
  Core::LinAlg::Matrix<nsd_, bdrynen_> evelaf(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<bdrynen_, 1> epreaf(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<bdrynen_, 1> escaaf(Core::LinAlg::Initialization::set_zero);
    ...
    if (normvel < -0.0001)
    {
      ...
      */
      ...
      if (is_newton)
      {
        ...
        Core::LinAlg::Matrix<nsd_, nsd_> n_x_u(Core::LinAlg::Initialization::set_zero);
    ...
    std::vector<double>& enormals)
{
  ...
  // node normals &
  Core::LinAlg::Matrix<nsd_, bdrynen_> norm_elem(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<bdrynsd_, nsd_> dxyzdrs(Core::LinAlg::Initialization::set_zero);

  // coordinates of current node in reference coordinates
  Core::LinAlg::Matrix<bdrynsd_, 1> xsi_node(Core::LinAlg::Initialization::set_zero);
  ...
  for (int inode = 0; inode < bdrynen_; ++inode)
  {
    ...
    Core::LinAlg::Matrix<bdrynsd_, bdrynsd_> metrictensor(Core::LinAlg::Initialization::set_zero);
    ...
    Core::FE::Discretization& discretization, std::vector<int>& lm)
{
  ...
  Core::LinAlg::Matrix<1, bdrynen_> eprenp(Core::LinAlg::Initialization::set_zero);
  for (int inode = 0; inode < bdrynen_; inode++)
  {
    ...
    Core::FE::Discretization& discretization, std::vector<int>& lm)
{
  ...
  Core::LinAlg::Matrix<(nsd_), 1> xyzGe(Core::LinAlg::Initialization::set_zero);
  ...
  for (int i = 0; i < nsd_; i++)
  {
    ...
    for (int gpid = 0; gpid < intpoints.ip().nquad; gpid++)
    {
      ...
      // global coordinates of gausspoint
      Core::LinAlg::Matrix<(nsd_), 1> coordgp(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseVector& elevec1)
{
  ...
  Core::LinAlg::Matrix<nsd_, bdrynen_> evelnp(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseVector& elevec3)
{
  ...
  for (int gpid = 0; gpid < intpoints.ip().nquad; gpid++)
  {
    ...
    //-------------------------------------------------------------------
    //  Q
    Core::LinAlg::Matrix<3, 1> u(Core::LinAlg::Initialization::set_zero);
    ...
    if (params.get<bool>("flowrateonly", false) == false)
    {
      ...
      Core::LinAlg::Matrix<3, bdrynen_ * 3> normalderiv(Core::LinAlg::Initialization::set_zero);
