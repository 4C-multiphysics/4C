  ...
  namespace Elements
  {
    namespace XFLUID
    {
      ...
      )
      {
        ...
        Core::LinAlg::Matrix<nsd_, 1> velint_s(Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<slave_nen_, 1> slave_funct(Core::LinAlg::Initialization::set_zero);
      ...
      )
      {
        ...
        // background here)
        Core::LinAlg::Matrix<nen_, slave_nen_> bG_ms(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<slave_nen_, nen_> bG_sm(Core::LinAlg::Initialization::set_zero);
