    ...
    Core::LinAlg::SerialDenseVector::Base& elevec_epetra)
{
  ...
  if (curvefac > 0.0)
  {
    ...
    Core::LinAlg::Matrix<nsd, piel> pxyze(Core::LinAlg::Initialization::set_zero);
    ...
    // get local node coordinates
    Core::LinAlg::Matrix<nsd, biel> bxyze(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<nsd, piel> pevelaf(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<piel, 1> pescaaf(Core::LinAlg::Initialization::set_zero);
    ...
    //---------------------------------------------------------------------
    Core::LinAlg::Matrix<nsd, 1> pxsi(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<piel, 1> pfunct(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<nsd, piel> pderiv(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<nsd, 1> unitnormal(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<nsd, piel> pderxy(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<nsd, 1> pvelaf(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<nsd, nsd> pvderxyaf(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<bnsd, biel> deriv(Core::LinAlg::Initialization::set_zero);
    ...
    for (int iquad = 0; iquad < bintpoints.ip().nquad; ++iquad)
    {
      ...
      drs_ = 0.0;
      Core::LinAlg::Matrix<bnsd, bnsd> metrictensor(Core::LinAlg::Initialization::set_zero);
          ...
          */
          ...
          if (is_newton)
          {
            ...
            */
            ...
            Core::LinAlg::Matrix<nsd, nsd> n_x_u(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseVector::Base& elevec_epetra)
{
  ...
  Core::LinAlg::Matrix<1, biel> epressnp(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseVector::Base& elevec_epetra)
{
  ...
  Core::LinAlg::Matrix<nsd, piel> pevelnp(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<piel, 1> peprenp(Core::LinAlg::Initialization::set_zero);
  for (int inode = 0; inode < piel; ++inode)
  {
    for (int idim = 0; idim < nsd; ++idim)
    {
  ...
  Core::LinAlg::Matrix<nsd, 1> unitnormal(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<nsd, piel> pderxy(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<nsd, 1> pvelintaf(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<nsd, 1> pvelintnp(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<nsd, nsd> pvderxyaf(Core::LinAlg::Initialization::set_zero);
  ...
  for (int iquad = 0; iquad < bintpoints.ip().nquad; ++iquad)
  {
    ...
    */
    ...
    Core::LinAlg::Matrix<nsd, 1> coordgp(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseVector::Base& elevec_epetra)
{
  ...
  Core::LinAlg::Matrix<nsd, 1> u_dirich(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<numstressdof_ * piel, piel> mat_r_p(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<numstressdof_ * piel, 1> vec_r_p(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<numstressdof_ * piel, 1> vec_r_epsu(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<nsd, piel> pevel(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<piel, 1> pepres(Core::LinAlg::Initialization::set_zero);
    ...
    <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>*/
  {
    ...
    Core::LinAlg::Matrix<nsd, 1> pvelint(Core::LinAlg::Initialization::set_zero);
    // velocity derivatives at gausspoint
    Core::LinAlg::Matrix<nsd, nsd> pvderxy(Core::LinAlg::Initialization::set_zero);
    ...
    for (int iquad = 0; iquad < pintpoints.ip().nquad; ++iquad)
    {
      ...
      */
      ...
      {
        Core::LinAlg::Matrix<numstressdof_, 1> temp(Core::LinAlg::Initialization::set_zero);
  ...
  double normtraction = 0.0;
  {
    if (nsd == 3)
    {
      ...
      Core::LinAlg::Matrix<nsd, 1> unitnormal(Core::LinAlg::Initialization::set_zero);
      // velocity at gausspoint
      Core::LinAlg::Matrix<nsd, 1> velint(Core::LinAlg::Initialization::set_zero);

      // transposed jacobian "dx/ds"
      Core::LinAlg::Matrix<nsd, nsd> xjm(Core::LinAlg::Initialization::set_zero);
      // inverse of transposed jacobian "ds/dx"
      Core::LinAlg::Matrix<nsd, nsd> xji(Core::LinAlg::Initialization::set_zero);
      ...
      for (int iquad = 0; iquad < intpoints.ip().nquad; ++iquad)
      {
        ...
        // ------------------------------------------------
        // factor given by spatial function
        Core::LinAlg::Matrix<nsd, 1> functionfac(Core::LinAlg::Initialization::set_zero);
        for (int i = 0; i < nsd; ++i)
        {
          functionfac(i) = 1.0;
        }
        ...
        Core::LinAlg::Matrix<3, 1> coordgp(Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<nsd, 1> delta_vel(Core::LinAlg::Initialization::set_zero);
      ...
      for (int iquad = 0; iquad < intpoints.ip().nquad; ++iquad)
      {
        ...
        Core::LinAlg::Matrix<numstressdof_, 1> GP_stress(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<nsd, 1> traction(Core::LinAlg::Initialization::set_zero);
    ...
    <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>*/
  {
    ...
    for (int iquad = 0; iquad < intpoints.ip().nquad; ++iquad)
    {
      ...
      */
      ...
      {
        Core::LinAlg::Matrix<nsd, 1> temp(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<nsd, 1> tempA(Core::LinAlg::Initialization::set_zero);
