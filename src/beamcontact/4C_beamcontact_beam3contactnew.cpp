      ...
      radius2_(0.0)
{
  ...
  Core::LinAlg::Matrix<3, 1, double> lvec1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, double> lvec2(Core::LinAlg::Initialization::set_zero);
  for (int i = 0; i < 3; i++)
  {
    ...
    Core::LinAlg::Matrix<3 * numnodes * numnodalvalues, 1, TYPE>* fc2_FAD)
{
  ...
  Core::LinAlg::Matrix<3, 1, TYPE> r1_lastiter(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> r2_lastiter(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> vc1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> vc2(Core::LinAlg::Initialization::set_zero);
  TYPE fd = 0.0;
  TYPE d = 0.0;
    ...
    const Core::LinAlg::Matrix<3, 3 * numnodes * numnodalvalues, TYPE>& N2_xixi)
{
  Core::LinAlg::Matrix<3, 1, TYPE> r1_lastiter(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> r2_lastiter(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> r1_xi_lastiter(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> r2_xi_lastiter(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> vc1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> vc2(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> vc1_xi(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> vc2_xi(Core::LinAlg::Initialization::set_zero);
  TYPE fd = 0.0;
  TYPE dfd = 0.0;
  TYPE d = 0.0;
  TYPE dd = 0.0;
...
void CONTACT::Beam3contactnew<numnodes, numnodalvalues>::closest_point_projection()
{
  ...
  // (1997)
  Core::LinAlg::Matrix<3, 1, TYPE> b_1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> b_2(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> t_1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, TYPE> t_2(Core::LinAlg::Initialization::set_zero);
...
void CONTACT::Beam3contactnew<numnodes, numnodalvalues>::update_class_variables_step()
{
  ...
  {
    Core::LinAlg::Matrix<3, 1> midpos1(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> midpos2(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> nodedistance1(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> nodedistance2(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> diffvector(Core::LinAlg::Initialization::set_zero);
    for (int i = 0; i < 3; i++)
    {
      midpos1(i) =
    ...
    std::map<std::pair<int, int>, std::shared_ptr<Beam3contactinterface>>& contactpairmap)
{
  ...
  Core::LinAlg::Matrix<3, 1> delta_r(Core::LinAlg::Initialization::set_zero);
