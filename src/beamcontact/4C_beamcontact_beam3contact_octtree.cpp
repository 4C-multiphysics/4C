...
Core::LinAlg::Matrix<6, 1> Beam3ContactOctTree::get_root_box()
{
  ...
  Core::LinAlg::Matrix<6, 1> lim(Core::LinAlg::Initialization::set_zero);
...
{
  Core::LinAlg::Matrix<3, 1> coord_max(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1> coord_min(Core::LinAlg::Initialization::set_zero);
  for (int k = 0; k < 3; ++k)
  {
    coord_max(k) = -1.0e12;
    coord_min(k) = 1.0e12;
