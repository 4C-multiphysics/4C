    ...
    Core::LinAlg::SparseMatrix& stiffmatrix, Core::LinAlg::Vector<double>& fint, const double& pp)
{
  ...
  Core::LinAlg::Matrix<dim1, 1, TYPEBTS> fc1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim2, 1, TYPEBTS> fc2(Core::LinAlg::Initialization::set_zero);

  // Temporary matrices for contact stiffness
  Core::LinAlg::Matrix<dim1, dim1 + dim2, TYPEBTS> stiffc1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim2, dim1 + dim2, TYPEBTS> stiffc2(Core::LinAlg::Initialization::set_zero);
        ...
        stiffc2_FAD)
{
  ...
  Core::LinAlg::Matrix<3, 3 * numnodes * numnodalvalues, TYPEBTS> N1(
      Core::LinAlg::Initialization::set_zero);  // = N1
  Core::LinAlg::Matrix<3, 3 * numnodes * numnodalvalues, TYPEBTS> N1_eta(
      Core::LinAlg::Initialization::set_zero);  // = N1,eta
  Core::LinAlg::Matrix<3, 3 * numnodes * numnodalvalues, TYPEBTS> N1_etaeta(
      Core::LinAlg::Initialization::set_zero);  // = N1,etaeta

  Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS> N2(
      Core::LinAlg::Initialization::set_zero);  // = N2
  Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS> N2_xi1(
      Core::LinAlg::Initialization::set_zero);  // = N2,xi1
  Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS> N2_xi2(
      Core::LinAlg::Initialization::set_zero);  // = N2,xi2
  Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS> N2_xi1xi1(
      Core::LinAlg::Initialization::set_zero);  // = N2,xi1xi1
  Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS> N2_xi2xi2(
      Core::LinAlg::Initialization::set_zero);  // = N2,xi2xi2
  Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS> N2_xi1xi2(
      Core::LinAlg::Initialization::set_zero);  // = N2,xi1xi2
  Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS> N2_xi2xi1(
      Core::LinAlg::Initialization::set_zero);  // = N2,xi2xi1

  // Coords and derivatives of beam and surface element
  Core::LinAlg::Matrix<3, 1, TYPEBTS> r1(Core::LinAlg::Initialization::set_zero);      // = r1
  Core::LinAlg::Matrix<3, 1, TYPEBTS> r1_eta(Core::LinAlg::Initialization::set_zero);  // = r1,eta
  Core::LinAlg::Matrix<3, 1, TYPEBTS> r1_etaeta(
      Core::LinAlg::Initialization::set_zero);  // = r1,etaeta

  Core::LinAlg::Matrix<3, 1, TYPEBTS> x2(Core::LinAlg::Initialization::set_zero);      // = x2
  Core::LinAlg::Matrix<3, 1, TYPEBTS> x2_xi1(Core::LinAlg::Initialization::set_zero);  // = x2,xi1
  Core::LinAlg::Matrix<3, 1, TYPEBTS> x2_xi2(Core::LinAlg::Initialization::set_zero);  // = x2,xi2
  Core::LinAlg::Matrix<3, 1, TYPEBTS> x2_xi1xi1(
      Core::LinAlg::Initialization::set_zero);  // = x2,xi1xi1
  Core::LinAlg::Matrix<3, 1, TYPEBTS> x2_xi2xi2(
      Core::LinAlg::Initialization::set_zero);  // = x2,xi2xi2
  Core::LinAlg::Matrix<3, 1, TYPEBTS> x2_xi1xi2(
      Core::LinAlg::Initialization::set_zero);  // = x2,xi1xi2
  Core::LinAlg::Matrix<3, 1, TYPEBTS> x2_xi2xi1(
      Core::LinAlg::Initialization::set_zero);  // = x2,xi2xi1

  // Distance vector its norm and distance unit vector
  Core::LinAlg::Matrix<3, 1, TYPEBTS> rD(Core::LinAlg::Initialization::set_zero);  // = r1 - x2
  TYPEBTS norm_rD = 0.0;                                                           // = ||rD||
  Core::LinAlg::Matrix<3, 1, TYPEBTS> nD(Core::LinAlg::Initialization::set_zero);  // = rD / norm_rD

  // Surface tangent cross product, its norm and unit surface normal vector
  Core::LinAlg::Matrix<3, 1, TYPEBTS> a2(
      Core::LinAlg::Initialization::set_zero);  // = x2_xi1 x x2_xi2
  TYPEBTS norm_a2 = 0.0;                        // = ||a||
  Core::LinAlg::Matrix<3, 1, TYPEBTS> n2(Core::LinAlg::Initialization::set_zero);  // = a / norm_a
  ...
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> eta_a_d(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> eta_b_d(Core::LinAlg::Initialization::set_zero);

  // Compute directional derivatives eta_a_d (i = 0) and eta_b_d (i = 1)
  // TODO: May this can be done in a more beautiful way
  for (int i = 0; i < 2; i++)
  {
    Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> eta_d(Core::LinAlg::Initialization::set_zero);
    ...
    // eta
    Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi1_d(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi2_d(Core::LinAlg::Initialization::set_zero);
    ...
    else
    {
      ...
      Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi_1d_FAD(
          Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi_2d_FAD(
          Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> eta_d_FAD(
          Core::LinAlg::Initialization::set_zero);
        ...
        stiffc2_FAD)
{
  ...
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi1_d(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi2_d(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> gap_d(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, dim1 + dim2, TYPEBTS> rD_d(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, dim1 + dim2, TYPEBTS> nD_d(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, dim1 + dim2, TYPEBTS> n2_d(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi_1d_FAD(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> xi_2d_FAD(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<dim1 + dim2, 1, TYPEBTS> gap_d_FAD(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, dim1 + dim2, TYPEBTS> rD_d_FAD(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, dim1 + dim2, TYPEBTS> nD_d_FAD(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, dim1 + dim2, TYPEBTS> n_2d_FAD(Core::LinAlg::Initialization::set_zero);
  ...
  // Part I: gap_d
  Core::LinAlg::Matrix<dim1, 1, TYPEBTS> N1T_n2(Core::LinAlg::Initialization::set_zero);
  for (int i = 0; i < 3; i++)
  ...
  if (completestiff)
  {
    ...
    // Part III: N1_d
    Core::LinAlg::Matrix<dim1, 1, TYPEBTS> N1_etaT_n2(Core::LinAlg::Initialization::set_zero);
    for (int i = 0; i < 3; i++)
  ...
  // Part I: gap_d
  Core::LinAlg::Matrix<dim2, 1, TYPEBTS> N2T_n2(Core::LinAlg::Initialization::set_zero);
  for (int i = 0; i < 3; i++)
  ...
  if (completestiff)
  {
    ...
    // Part III: N2_d
    Core::LinAlg::Matrix<dim2, 1, TYPEBTS> N2_xi1T_n2(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<dim2, 1, TYPEBTS> N2_xi2T_n2(Core::LinAlg::Initialization::set_zero);
    for (int i = 0; i < 3; i++)
    {
      for (int j = 0; j < dim2; j++)
      {
  ...
  Core::LinAlg::Matrix<dim1, 1, TYPEBTS> fc1_FAD(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim2, 1, TYPEBTS> fc2_FAD(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS>& N2_xi2)
{
  ...
  // Initialize matrices
  Core::LinAlg::Matrix<2, 2, TYPEBTS> L(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, 3, TYPEBTS> Lpar(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, 2, TYPEBTS> L_inv(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, dim1 + dim2, TYPEBTS> B(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, dim1 + dim2, TYPEBTS> D(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 3 * numnodessol, TYPEBTS>& N2_xi2)
{
  ...
  Core::LinAlg::Matrix<3, 3, TYPEBTS> auxiliary_matrix(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3, TYPEBTS> x2_xi1_tilde(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3, TYPEBTS> x2_xi2_tilde(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, dim1 + dim2, TYPEBTS> a2_d(Core::LinAlg::Initialization::set_zero);
  for (int i = 0; i < 3; i++)
  {
    for (int j = 0; j < dim1 + dim2; j++)
    {
    ...
    const int& fixed_par, TYPEBTS& xi1, TYPEBTS& xi2, TYPEBTS& eta, bool& proj_allowed)
{
  ...
  Core::LinAlg::Matrix<2, 1, TYPEBTS> f(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, 3, TYPEBTS> Jpar(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, 2, TYPEBTS> J(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, 2, TYPEBTS> Jinv(Core::LinAlg::Initialization::set_zero);
  ...
  for (iter = 0; iter < BEAMCONTACTMAXITER; iter++)
  {
    ...
    Core::LinAlg::Matrix<2, 2, TYPEBTS> J_FAD(Core::LinAlg::Initialization::set_zero);
  ...
  {
    Core::LinAlg::Matrix<3, 1, TYPEBTS> n2(Core::LinAlg::Initialization::set_zero);
    double sgn = 1.0;
    ...
    const TYPEBTS& xi2)
{
  ...
  Core::LinAlg::Matrix<1, numnodessol, TYPEBTS> N_i(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, numnodessol, TYPEBTS> N_i_xi(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, numnodessol, TYPEBTS> N_i_xixi(Core::LinAlg::Initialization::set_zero);
        ...
        stiffc2)
{
  ...
  Core::LinAlg::Matrix<dim1, dim1 + dim2, TYPEBTS> stiffc1_FD(
      Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<dim2, dim1 + dim2, TYPEBTS> stiffc2_FD(
      Core::LinAlg::Initialization::set_zero);
  ...
  for (int col = 0; col < dim1 + dim2; col++)
  {
    ...
    Core::LinAlg::Matrix<dim1, 1, TYPEBTS> fc1_h(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<dim2, 1, TYPEBTS> fc2_h(Core::LinAlg::Initialization::set_zero);

    // Temporary matrices for contact stiffness at position with added h
    Core::LinAlg::Matrix<dim1, dim1 + dim2, TYPEBTS> stiffc1_h(
        Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<dim2, dim1 + dim2, TYPEBTS> stiffc2_h(
        Core::LinAlg::Initialization::set_zero);
