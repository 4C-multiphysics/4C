...
namespace
{
  ...
  {
    // auxiliaries
    Core::LinAlg::Matrix<3, 1> temp3x1(Core::LinAlg::Initialization::set_zero);
      ...
      const std::vector<Core::LinAlg::Matrix<loc_dim, 1>>& ref_locs, const unsigned int& base_ind)
  {
    ...
    // matrix
    Core::LinAlg::Matrix<loc_dim, 1> diff_locs(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<loc_dim, 1>& interp_loc)
{
  ...
  Core::LinAlg::Matrix<3, 3> output(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 1> ln_lambda_interp(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 1> rot_vect_Q_rel_interp(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 1> rot_vect_R_rel_interp(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3> Q_interp(Core::LinAlg::Initialization::set_zero);
  Q_interp.multiply_nn(1.0, all_Q[base_ind], Q_rel_interp, 0.0);
  Core::LinAlg::Matrix<3, 3> R_interp(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3> lambda_interp(Core::LinAlg::Initialization::set_zero);
    ...
    std::array<std::pair<double, Core::LinAlg::Matrix<3, 1>>, 3>& spectral_pairs)
{
  ...
  Core::LinAlg::Matrix<3, 3> U_squared(Core::LinAlg::Initialization::set_zero);
  U_squared.multiply_tn(1.0, inp_matrix, inp_matrix, 0.0);

  // decompose squared stretch tensors U
  Core::LinAlg::Matrix<3, 3> eigenvectors_U(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 3> eigenvalues_U(Core::LinAlg::Initialization::set_zero);
  temp3x3.clear();
    ...
    const Core::LinAlg::Matrix<3, 3>& rot_matrix)
{
  ...
  Core::LinAlg::Matrix<3, 1> rot_vect(Core::LinAlg::Initialization::set_zero);

  // --> interpolate quaternion from rotation matrix using Spurrier's algorithm

  // utilities
  Core::LinAlg::Matrix<4, 1> tensor_characteristics(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<4, 1> quaternion(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<4, 1> unit_quaternion(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 1>& rot_vect)
{
  ...
  Core::LinAlg::Matrix<3, 3> rot_matrix(Core::LinAlg::Initialization::set_zero);
  ...
  if (angle > 1.0e-16)
  {
    ...
    Core::LinAlg::Matrix<3, 1> norm_rot_vect(Core::LinAlg::Initialization::set_zero);
    norm_rot_vect.update(1.0 / angle, rot_vect, 0.0);

    // compute S matrix with components from the normalized rotation vector
    Core::LinAlg::Matrix<3, 3> S(Core::LinAlg::Initialization::set_zero);
    ...
    // \f$ \bm{S} \bm{S} \f$
    Core::LinAlg::Matrix<3, 3> SS(Core::LinAlg::Initialization::set_zero);
    ...
    const std::vector<double>& ref_locs, const double interp_loc)
{
  ...
  Core::LinAlg::Matrix<1, 1> converted_interp_loc(Core::LinAlg::Initialization::set_zero);
