...
Core::LinAlg::Matrix<dim, dim> Core::LinAlg::matrix_exp(const Core::LinAlg::Matrix<dim, dim>& input)
{
  ...
  Core::LinAlg::Matrix<dim, dim> output(Core::LinAlg::Initialization::set_zero);
  ...
  else
  {
    ...
    Core::LinAlg::Matrix<dim, dim, std::complex<double>> temp(
        Core::LinAlg::Initialization::set_zero);
...
{
  // auxiliaries
  Core::LinAlg::Matrix<dim, dim> id(Core::LinAlg::Initialization::set_zero);
  for (unsigned int i = 0; i < dim; ++i)
  {
    id(i, i) = 1.0;
  }
  Core::LinAlg::Matrix<dim, dim> temp(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<dim, dim> id_minus_A(Core::LinAlg::Initialization::set_zero);
  ...
  if (id_minus_A.norm2() < 1.0)
  {
    ...
    Core::LinAlg::Matrix<dim, dim> A_minus_id(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<dim, dim> id_plus_A(Core::LinAlg::Initialization::set_zero);
  id_plus_A.update(1.0, id, 1.0, input, 0.0);

  // \f$ \left( \boldsymbol{I} + \boldsymbol{A} \right)^{-1} \f$
  Core::LinAlg::Matrix<dim, dim> inv_id_plus_A(Core::LinAlg::Initialization::set_zero);
  inv_id_plus_A.invert(id_plus_A);

  // update matrix: \f$ \left[ \left( \boldsymbol{I} - \boldsymbol{A} \right) \left( \boldsymbol{I}
  // + \boldsymbol{A}
  // \right)^{-1} \right] \f$
  Core::LinAlg::Matrix<dim, dim> update_mat(Core::LinAlg::Initialization::set_zero);
  ...
  if (update_mat.norm2() < 1.0)
  {
    ...
    // \f$
    Core::LinAlg::Matrix<dim, dim> update_mat_2mpl1(Core::LinAlg::Initialization::set_zero);
  ...
  else
  {
    ...
    Core::LinAlg::Matrix<dim, dim, std::complex<double>> tmp(
        Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<dim, dim, std::complex<double>> output_complex(
        Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 3>& input)
{
  ...
  Core::LinAlg::Matrix<9, 9> output(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3> tmp2(Core::LinAlg::Initialization::set_zero);
...
{
  // auxiliaries
  Core::LinAlg::Matrix<3, 3> id_3x3(Core::LinAlg::Initialization::set_zero);
  for (int i = 0; i < 3; ++i)
  {
    id_3x3(i, i) = 1.0;
  }
  Core::LinAlg::Matrix<9, 9> id4(Core::LinAlg::Initialization::set_zero);
  ...
  double conv_tol = 1.0e-10;
  // characteristic matrix \f$ \boldsymbol{I} - \boldsymbol{A} \f$
  Core::LinAlg::Matrix<3, 3> id_minus_A(Core::LinAlg::Initialization::set_zero);
  ...
  if (id_minus_A.norm2() < 1.0)
  {
    ...
    // \f$ \boldsymbol{A} - \boldsymbol{I} \f$
    Core::LinAlg::Matrix<3, 3> A_minus_id(Core::LinAlg::Initialization::set_zero);
    A_minus_id.update(1.0, input, -1.0, id_3x3);

    //\f$ \left( \bm{A} - \bm{I} \right)^T \f$
    Core::LinAlg::Matrix<3, 3> A_minus_idT(Core::LinAlg::Initialization::set_zero);
  ...
  else
  {
    ...
    // \f$ \bm{I} + \bm{A} \f$
    Core::LinAlg::Matrix<3, 3> id_plus_A(Core::LinAlg::Initialization::set_zero);
    id_plus_A.update(1.0, id_3x3, 1.0, input, 0.0);

    // \f$ \left( \bm{I} + \bm{A} \right)^{-1} \f$
    Core::LinAlg::Matrix<3, 3> inv_id_plus_A(Core::LinAlg::Initialization::set_zero);
    inv_id_plus_A.invert(id_plus_A);

    // \f$ \frac{\partial  \left( \bm{I} + \bm{A} \right)^{-1}}{\partial \bm{A}}  \f$
    Core::LinAlg::Matrix<9, 9> dinv_id_plus_A_dA(Core::LinAlg::Initialization::set_zero);
    temp9x9.clear();
    ...
    // \right)^{-1} \right] \f$
    Core::LinAlg::Matrix<3, 3> updateMat(Core::LinAlg::Initialization::set_zero);
    updateMat.multiply_nn(1.0, id_minus_A, inv_id_plus_A, 0.0);

    // get derivative of the update matrix w.r.t. input matrix \f$ \bm{A} \f$
    Core::LinAlg::Matrix<9, 9> dupdateMat_dA(Core::LinAlg::Initialization::set_zero);
    temp9x9.clear();
    ...
    Core::LinAlg::Matrix<9, 9> dupdateMat_dA_mmin1(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<6, 6>* ddexp_mat)
{
  ...
  // temporary matrices
  Core::LinAlg::Matrix<3, 3> akm(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 3> ak(Core::LinAlg::Initialization::set_zero);
