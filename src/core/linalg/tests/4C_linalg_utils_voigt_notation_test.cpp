...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<6, 1> cmp_stress(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<6, 1> cmp_strain(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<3, 1> prinv(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<6, 1> items_stress_result(
  ...
  {
    Core::LinAlg::Matrix<6, 1> items_strain_result(
        Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<6, 1> strain_to_stress(Core::LinAlg::Initialization::leave_uninitialized);
    Core::LinAlg::Matrix<6, 1> stress_to_stress(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<6, 1> strain_to_strain(Core::LinAlg::Initialization::leave_uninitialized);
    Core::LinAlg::Matrix<6, 1> stress_to_strain(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<6, 1> id(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<3, 3> matrix(Core::LinAlg::Initialization::leave_uninitialized);
