...
namespace
{
  TEST(TensorSymmetricEinsteinSummationTest, Dyadic)
  {
    ...
    Core::LinAlg::SymmetricTensor<double, 3, 3> tt = einsum_sym(einidx<0>(t), einidx<1>(t));
  ...
  TEST(TensorSymmetricEinsteinSummationTest, Dyadic3)
  {
    ...
    Core::LinAlg::SymmetricTensor<double, 3, 3, 3, 3> t1t2t2 =
        einsum_sym(einidx<0, 1>(t1), einidx<2>(t2), einidx<3>(t2));
  ...
  TEST(TensorSymmetricEinsteinSummationTest, MatrixProduct)
  {
    ...
    Core::LinAlg::SymmetricTensor<double, 3, 3> FTMF =
        einsum_sym(einidx<0, 1>(F), einidx<0, 2>(M_sym), einidx<2, 3>(F));
