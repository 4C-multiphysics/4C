...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<2, 2, double> A_singular(Core::LinAlg::Initialization::set_zero);
    A_singular(0, 0) = 1.0;
  ...
  {
    Core::LinAlg::Matrix<3, 3, double> A_singular(Core::LinAlg::Initialization::set_zero);
    A_singular(0, 0) = 1.0;
    A_singular(1, 1) = 1.0;
    EXPECT_ANY_THROW(Core::LinAlg::inverse(A_singular));
  }
  ...
  {
    Core::LinAlg::Matrix<4, 4, double> A_singular(Core::LinAlg::Initialization::set_zero);
    A_singular(0, 0) = 1.0;
    A_singular(1, 1) = 1.0;
    A_singular(2, 2) = 1.0;
    EXPECT_ANY_THROW(Core::LinAlg::inverse(A_singular));
  ...
  {
    Core::LinAlg::Matrix<4, 4, double> A(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<4, 1, double> b(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<4, 1, double> x(Core::LinAlg::Initialization::set_zero);
