...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<2, 2> A(Core::LinAlg::Initialization::set_zero);
    A(0, 0) = 0.1320698936;
    A(0, 1) = 0.7174840819;
    A(1, 0) = 0.9846543275;
    A(1, 1) = 0.0134355791;

    Core::LinAlg::Matrix<2, 2> exp_A_ref(Core::LinAlg::Initialization::set_zero);
  ...
  TEST(LinalgDenseMatrixExpLogTest, 2x2MatrixLog)
  {
    ...
    Core::LinAlg::Matrix<2, 2> log_A_ref(Core::LinAlg::Initialization::set_zero);
  ...
  {
    Core::LinAlg::Matrix<3, 3> A(Core::LinAlg::Initialization::set_zero);
    A(0, 0) = 0.4908570193;
    A(0, 1) = 0.0227448063;
    A(0, 2) = 0.8823601080;
    A(1, 0) = 0.3080134014;
    ...
    Core::LinAlg::Matrix<3, 3> exp_A_ref(Core::LinAlg::Initialization::set_zero);
  ...
  TEST(LinalgDenseMatrixExpLogTest, MatrixExp1stDeriv)
  {
    ...
    Core::LinAlg::Matrix<9, 9> dexp_dA_ref(Core::LinAlg::Initialization::set_zero);
  ...
  TEST(LinalgDenseMatrixExpLogTest, SymMatrix3x3Exp1stDeriv)
  {
    ...
    Core::LinAlg::Matrix<6, 6> dexp_dA_ref(Core::LinAlg::Initialization::set_zero);
  ...
  TEST(LinalgDenseMatrixExpLogTest, 3x3MatrixLog)
  {
    ...
    Core::LinAlg::Matrix<3, 3> log_A_ref(Core::LinAlg::Initialization::set_zero);
  ...
  TEST(LinalgDenseMatrixExpLogTest, MatrixLog1stDeriv)
  {
    ...
    Core::LinAlg::Matrix<9, 9> dlog_dA_ref(Core::LinAlg::Initialization::set_zero);
