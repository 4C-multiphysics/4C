...
namespace
{
  TEST(LinalgTensorInterpolationTest, 2Sym3x3MatrixInterp2D)
  {
    ...
    Core::LinAlg::Matrix<3, 3> lambda_T_1(Core::LinAlg::Initialization::set_zero);
    lambda_T_1(0, 0) = 10.0;
    lambda_T_1(1, 1) = 1.0;
    lambda_T_1(2, 2) = 1.0;
    Core::LinAlg::Matrix<3, 3> Q_T_1(Core::LinAlg::Initialization::set_zero);
    ...
    Q_T_1(2, 2) = 1.0;
    Core::LinAlg::Matrix<3, 3> T_1(Core::LinAlg::Initialization::set_zero);
    temp3x3.multiply_tn(1.0, Q_T_1, lambda_T_1, 0.0);
    T_1.multiply_nn(1.0, temp3x3, Q_T_1, 0.0);
    Core::LinAlg::Matrix<1, 1> loc_T_1(Core::LinAlg::Initialization::set_zero);
    loc_T_1(0, 0) = -5.0;

    Core::LinAlg::Matrix<3, 3> lambda_T_2(Core::LinAlg::Initialization::set_zero);
    lambda_T_2(0, 0) = 20.0;
    lambda_T_2(1, 1) = 4.0;
    lambda_T_2(2, 2) = 1.0;
    Core::LinAlg::Matrix<3, 3> Q_T_2(Core::LinAlg::Initialization::set_zero);
    ...
    Q_T_2(2, 2) = 1.0;
    Core::LinAlg::Matrix<3, 3> T_2(Core::LinAlg::Initialization::set_zero);
    temp3x3.multiply_tn(1.0, Q_T_2, lambda_T_2, 0.0);
    T_2.multiply_nn(1.0, temp3x3, Q_T_2, 0.0);
    Core::LinAlg::Matrix<1, 1> loc_T_2(Core::LinAlg::Initialization::set_zero);
    loc_T_2(0, 0) = 5.0;
    ...
    Core::LinAlg::Matrix<1, 1> loc_interp(Core::LinAlg::Initialization::set_zero);

    Core::LinAlg::Matrix<3, 3> T_interp =
        interp.get_interpolated_matrix(ref_matrices, ref_locs, loc_interp);

    // reference result
    Core::LinAlg::Matrix<3, 3> lambda_T_ref(Core::LinAlg::Initialization::set_zero);
    lambda_T_ref(0, 0) =
    ...
    Core::LinAlg::Matrix<3, 3> Q_T_ref(Core::LinAlg::Initialization::set_zero);
    ...
    Q_T_ref(2, 2) = 1.0;
    Core::LinAlg::Matrix<3, 3> T_ref(Core::LinAlg::Initialization::set_zero);
  ...
  TEST(LinalgTensorInterpolationTest, 2NonSym3x3MatrixInterp2D)
  {
    ...
    Q_T_1(2, 2) = 1.0;
    Core::LinAlg::Matrix<3, 3> R_T_1(Core::LinAlg::Initialization::set_zero);
    ...
    Q_T_ref(2, 2) = 1.0;
    Core::LinAlg::Matrix<3, 3> R_T_ref(Core::LinAlg::Initialization::set_zero);
