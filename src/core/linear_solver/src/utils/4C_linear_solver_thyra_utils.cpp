...
Core::LinAlg::MultiVector<double> Core::LinearSolver::Utils::create_epetra_multivector(
    const Teuchos::RCP<const Thyra::MultiVectorBase<double>>& thyraX, const Core::LinAlg::Map& map)
{
  ...
  return Core::LinAlg::MultiVector<double>(epetra_multi_vector);
}
