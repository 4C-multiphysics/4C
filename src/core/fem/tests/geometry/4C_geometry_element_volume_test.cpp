...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<3, 2> xyz(Core::LinAlg::Initialization::set_zero);
    xyz(0, 0) = 0.0;
    xyz(1, 0) = 0.0;
    xyz(2, 0) = 0.0;  // node 1
    xyz(0, 1) = 2.0;
  ...
  {
    Core::LinAlg::Matrix<3, 3> xyz(Core::LinAlg::Initialization::set_zero);
    xyz(0, 0) = 0.0;
    xyz(1, 0) = 0.0;
    xyz(2, 0) = 0.0;  // node 1
    xyz(0, 1) = 2.0;
  ...
  {
    Core::LinAlg::Matrix<3, 6> xyz(Core::LinAlg::Initialization::set_zero);
    xyz(0, 0) = 0.0;
    xyz(1, 0) = 0.0;
    xyz(2, 0) = 0.0;  // node 1
    xyz(0, 1) = 1.0;
  ...
  {
    Core::LinAlg::Matrix<3, 4> xyz(Core::LinAlg::Initialization::set_zero);
    xyz(0, 0) = 0.0;
    xyz(1, 0) = 0.0;
    xyz(2, 0) = 0.0;  // node 1
    xyz(0, 1) = 2.0;
  ...
  {
    Core::LinAlg::Matrix<3, 8> xyz(Core::LinAlg::Initialization::set_zero);
    xyz(0, 0) = 0.0;
    xyz(1, 0) = 0.0;
    xyz(2, 0) = 0.0;  // node 1
    xyz(0, 1) = 2.0;
  ...
  {
    Core::LinAlg::Matrix<3, 9> xyz(Core::LinAlg::Initialization::set_zero);
    xyz(0, 0) = 0.0;
    xyz(1, 0) = 0.0;
    xyz(2, 0) = 0.0;  // node 1
    xyz(0, 1) = 2.0;
  ...
  {
    Core::LinAlg::Matrix<3, 10> xyz(Core::LinAlg::Initialization::set_zero);
    xyz(0, 0) = 0.0;
    xyz(1, 0) = 0.0;
    xyz(2, 0) = 0.0;  // node 1
    xyz(0, 1) = 1.0;
  ...
  {
    Core::LinAlg::Matrix<3, 20> xyz(Core::LinAlg::Initialization::set_zero);
  ...
  {
    Core::LinAlg::Matrix<3, 27> xyz(Core::LinAlg::Initialization::set_zero);
