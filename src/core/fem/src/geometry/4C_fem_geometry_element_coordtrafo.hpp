...
namespace Core::Geo
{
  ...
  */
      ...
      Core::LinAlg::Matrix<Core::FE::dim<distype>, 1>& xsi)
  {
    ...
    Core::LinAlg::Matrix<numDim, numDim> A(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<numDim, numDim> A_inv(Core::LinAlg::Initialization::set_zero);

    Core::LinAlg::Matrix<numDim, 1> b(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<numDim, 1> dx(Core::LinAlg::Initialization::set_zero);

    // initialize != 0
    dx(0) = 1.0;

    Core::LinAlg::Matrix<numNodes, 1> funct(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<numDim, numNodes> deriv1(Core::LinAlg::Initialization::set_zero);
