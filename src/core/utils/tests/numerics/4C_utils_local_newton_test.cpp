...
namespace
{
  ...
  TEST(CoreUtilsLocalNewtonTest, NewtonVector)
  {
    ...
    {
      Core::LinAlg::Matrix<2, 1> residuum(Core::LinAlg::Initialization::leave_uninitialized);
      Core::LinAlg::Matrix<2, 2> jacobian(Core::LinAlg::Initialization::leave_uninitialized);
