  ...
  class FaceElementTemplateExtendedVolume : public FaceElementTemplate<Surface, ScalarType>
  {
   ...
   public:
    ...
    FaceElementTemplateExtendedVolume(
        ...
        : base_class(core_element),
          surface_dof_lid_map_(Core::LinAlg::Initialization::set_zero),
          face_to_volume_coordinate_axis_map_(Core::LinAlg::Initialization::set_zero),
          face_to_volume_coordinate_axis_factor_(Core::LinAlg::Initialization::set_zero),
          third_direction_(-1),
