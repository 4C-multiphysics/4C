    ...
    numnodalvalues>::evaluate_fpotand_stiffpot_large_sep_approx()
{
  ...
  Core::LinAlg::Matrix<3, 1, TYPE> dist(Core::LinAlg::Initialization::set_zero);  // = r1-r2
  ...
  // auxiliary variable
  Core::LinAlg::Matrix<3, 1, TYPE> fpot_tmp(Core::LinAlg::Initialization::set_zero);
  ...
  for (int gp1 = 0; gp1 < numgp; ++gp1)
  {
    ...
    Core::LinAlg::Matrix<3, 3, TYPE> dist_dist_T(Core::LinAlg::Initialization::set_zero);
