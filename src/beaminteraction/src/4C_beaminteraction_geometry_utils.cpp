    ...
    const Core::FE::CellType& master_distype, double master_ele_ref_length)
{
  ...
  Core::LinAlg::Matrix<1, numnodes * numnodalvalues, T> N_i(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, numnodes * numnodalvalues, T> N_i_xi(
  ...
  Core::LinAlg::Matrix<3, 1, T> r_master(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, T> r_xi_master(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, T> r_xixi_master(Core::LinAlg::Initialization::set_zero);

  Core::LinAlg::Matrix<3, 1, T> delta_r(Core::LinAlg::Initialization::set_zero);  // = r1-r2
    ...
    const Core::LinAlg::Matrix<3, 1, T>& r_xixixi_master)
{
  ...
  Core::LinAlg::Matrix<3, 3, T> unit_matrix(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3, T> delta_r_tensorproduct_r_xixi_master(
      Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 3, T> delta_r_tensorproduct_delta_r(
      Core::LinAlg::Initialization::set_zero);
