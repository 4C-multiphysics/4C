    ...
    const GEOMETRYPAIR::ProjectionPoint1DTo3D<double>& evaluation_point) const
{
  ...
  Core::LinAlg::Matrix<3, 1, ScalarType> r_beam(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, ScalarType> r_surface(Core::LinAlg::Initialization::set_zero);
