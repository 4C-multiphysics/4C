    ...
    Teuchos::ParameterList& visualization_params) const
{
      ...
      visualization_nodal_forces != nullptr)
  {
    ...
    if (visualization_nodal_forces != nullptr)
    {
      ...
      Core::LinAlg::Matrix<3, 1, double> lambda_gauss_point(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<3, 1, double> r_gauss_point(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<3, 1, double> temp_moment(Core::LinAlg::Initialization::set_zero);
