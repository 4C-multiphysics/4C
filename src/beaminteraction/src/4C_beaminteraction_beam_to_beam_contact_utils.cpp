    ...
    std::pair<double, double>& closestpoints, bool& etaset)
{
  ...
  Core::LinAlg::Matrix<3, 1, double> vec1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1, double> vec2(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 1, double>& rp, double& eta)
{
  ...
  Core::LinAlg::Matrix<3, 1, double> tline(Core::LinAlg::Initialization::set_zero);
