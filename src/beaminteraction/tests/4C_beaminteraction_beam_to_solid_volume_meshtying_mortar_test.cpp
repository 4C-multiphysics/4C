...
namespace
{
  ...
  /**
   * \brief Test a straight beam in a hex8 element, with dual hermite mortar shape functions.
   */
   ...
   */
  TEST_F(BeamToSolidVolumeMeshtyingPairMortarTest,
      TestBeamToSolidMeshtyingMortarHermite2Hex8DualHermite2Rot)
  {
    // Element types.
    using beam_type = GeometryPair::t_hermite;
    using solid_type = GeometryPair::t_hex8;
    using lambda_type = BeamInteraction::HermiteDual;
    ...
    result_local_D(3, 3) = 0.05114626125938329;
    result_local_D(4, 4) = 0.05114626125938329;
    result_local_D(5, 5) = 0.05114626125938329;
    result_local_D(6, 6) = 0.3290189488464655;
    result_local_D(7, 7) = 0.3290189488464655;
    result_local_D(8, 8) = 0.3290189488464655;
    result_local_D(9, 9) = -0.0554098872327261;
    result_local_D(10, 10) = -0.0554098872327261;
    result_local_D(11, 11) = -0.0554098872327261;
    ...
    result_local_M(3, 0) = -0.005303110126352352;
    result_local_M(3, 3) = -0.005775799921888689;
    result_local_M(3, 6) = -0.0013594338584344;
    result_local_M(3, 9) = -0.002921675461686673;
    result_local_M(3, 12) = -0.005783959506876726;
    result_local_M(3, 15) = 0.002293869594199332;
    result_local_M(3, 18) = 0.01831404400807368;
    result_local_M(3, 21) = 0.0005360652729662629;
    result_local_M(4, 1) = -0.005303110126352352;
    result_local_M(4, 4) = -0.005775799921888689;
    result_local_M(4, 7) = -0.0013594338584344;
    result_local_M(4, 10) = -0.002921675461686673;
    result_local_M(4, 13) = -0.005783959506876726;
    result_local_M(4, 16) = 0.002293869594199332;
    result_local_M(4, 19) = 0.01831404400807368;
    result_local_M(4, 22) = 0.0005360652729662629;
    result_local_M(5, 2) = -0.005303110126352352;
    result_local_M(5, 5) = -0.005775799921888689;
    result_local_M(5, 8) = -0.0013594338584344;
    result_local_M(5, 11) = -0.002921675461686673;
    result_local_M(5, 14) = -0.005783959506876726;
    result_local_M(5, 17) = 0.002293869594199332;
    result_local_M(5, 20) = 0.01831404400807368;
    result_local_M(5, 23) = 0.0005360652729662629;
    ...
    result_local_M(9, 0) = 0.005444253514376718;
    result_local_M(9, 3) = -0.00983046580573982;
    result_local_M(9, 6) = 0.003064403533400012;
    result_local_M(9, 9) = 0.00932805159170054;
    result_local_M(9, 12) = 0.003435515729139305;
    result_local_M(9, 15) = -0.01339256675559888;
    result_local_M(9, 18) = -0.002237474360217429;
    result_local_M(9, 21) = 0.004188282552939043;
    result_local_M(10, 1) = 0.005444253514376718;
    result_local_M(10, 4) = -0.00983046580573982;
    result_local_M(10, 7) = 0.003064403533400012;
    result_local_M(10, 10) = 0.00932805159170054;
    result_local_M(10, 13) = 0.003435515729139305;
    result_local_M(10, 16) = -0.01339256675559888;
    result_local_M(10, 19) = -0.002237474360217429;
    result_local_M(10, 22) = 0.004188282552939043;
    result_local_M(11, 2) = 0.005444253514376718;
    result_local_M(11, 5) = -0.00983046580573982;
    result_local_M(11, 8) = 0.003064403533400012;
    result_local_M(11, 11) = 0.00932805159170054;
    result_local_M(11, 14) = 0.003435515729139305;
    result_local_M(11, 17) = -0.01339256675559888;
    result_local_M(11, 20) = -0.002237474360217429;
    result_local_M(11, 23) = 0.004188282552939043;
