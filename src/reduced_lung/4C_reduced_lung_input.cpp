          ...
          group<ReducedLungParameters::LungTree>("lung_tree",
              {
                  ...
                  group<ReducedLungParameters::LungTree::Airways>("airways",
                      {
                          ...
                          group<ReducedLungParameters::LungTree::Airways::FlowModel>("flow_model",
                              {
                                  input_field<ReducedLungParameters::LungTree::Airways::FlowModel::
                                          ResistanceType>("resistance_type",
                                      {
                                          .description = "Type of resistance model for the airway.",
                                          .store = in_struct(&ReducedLungParameters::LungTree::
                                                  Airways::FlowModel::resistance_type),
                                      }),
                                  group<ReducedLungParameters::LungTree::Airways::FlowModel::
                                          ResistanceModel>("resistance_model",
                                      {group<ReducedLungParameters::LungTree::Airways::FlowModel::
                                              ResistanceModel::NonLinear>("non_linear",
                                          {input_field<double>("turbulence_factor_gamma",
                                              {
                                                  .description =
                                                      "Van Ertbruggen's generation dependent "
                                                      "turbulence factor defining turbulent onset.",
                                                  .store = in_struct(
                                                      &ReducedLungParameters::LungTree::Airways::
                                                          FlowModel::ResistanceModel::NonLinear::
                                                              turbulence_factor_gamma),
                                              })},
                                          {
                                              ...
                                              .store = in_struct(
                                                  &ReducedLungParameters::LungTree::Airways::
                                                      FlowModel::ResistanceModel::non_linear),
                                          })},
                                      {
                                          .description =
                                          ...
                                          .required = false,
                                          .store = in_struct(&ReducedLungParameters::LungTree::
                                                  Airways::FlowModel::resistance_model),
                                      }),
                                  input_field<bool>("include_inertia",
                                      {
                                          ...
                                          .store = in_struct(&ReducedLungParameters::LungTree::
                                                  Airways::FlowModel::include_inertia),
                                      }),
                              },
                              {
                                  .description = "Flow model of the airway.",
                                  .store = in_struct(
                                      &ReducedLungParameters::LungTree::Airways::flow_model),
                              }),
                          ...
                          group<ReducedLungParameters::LungTree::Airways::WallModel>("wall_model",
                              {
                                  group<ReducedLungParameters::LungTree::Airways::WallModel::
                                          KelvinVoigt>("kelvin_voigt",
                                      {group<ReducedLungParameters::LungTree::Airways::WallModel::
                                               KelvinVoigt::Elasticity>("elasticity",
                                           {
                                               input_field<double>("wall_poisson_ratio",
                                                   {
                                                       .description = "Poisson's ratio of the "
                                                                      "airway wall.",
                                                       .store = in_struct(
                                                           &ReducedLungParameters::LungTree::
                                                               Airways::WallModel::KelvinVoigt::
                                                                   Elasticity::wall_poisson_radio),
                                                   }),
                                               ...
                                               input_field<double>("diameter_over_wall_thickness",
                                                   {
                                                       ...
                                                       .store = in_struct(&ReducedLungParameters::
                                                               LungTree::Airways::WallModel::
                                           ...
                                           },
                                           {
                                               ...
                                               .required = false,
                                               .store = in_struct(&ReducedLungParameters::LungTree::
                                                       Airways::WallModel::KelvinVoigt::elasticity),
                                           }),
                                          group<ReducedLungParameters::LungTree::Airways::
                                                  WallModel::KelvinVoigt::Viscosity>("viscosity",
                                              {
                                              ...
                                              },
                                              {
                                                  ...
                                                  .store = in_struct(
                                                      &ReducedLungParameters::LungTree::Airways::
                                                          WallModel::KelvinVoigt::viscosity),
                                              })},
                                      {
                                          .description = "Kelvin-Voigt type airway wall model.",
                                          .required = false,
                                          .store = in_struct(&ReducedLungParameters::LungTree::
                                                  Airways::WallModel::kelvin_voigt),
                                      }),
                              },
                              {
                                  ...
                                  .required = false,
                                  .store = in_struct(
                                      &ReducedLungParameters::LungTree::Airways::wall_model),
                              }),
                      },
                      {
                  ...
                  group<ReducedLungParameters::LungTree::TerminalUnits>("terminal_units",
                      {
                          group<ReducedLungParameters::LungTree::TerminalUnits::RheologicalModel>(
                              "rheological_model",
                              {
                                  input_field<ReducedLungParameters::LungTree::TerminalUnits::
                                          RheologicalModel::RheologicalModelType>(
                                      "rheological_model_type",
                                      {
                                          .description = "Type of the rheological model.",
                                          .store = in_struct(
                                              &ReducedLungParameters::LungTree::TerminalUnits::
                                                  RheologicalModel::rheological_model_type),
                                      }),
                                  group<ReducedLungParameters::LungTree::TerminalUnits::
                                          RheologicalModel::KelvinVoigt>("kelvin_voigt",
                                      {
                                          input_field<double>("viscosity_kelvin_voigt_eta",
                                              {
                                                  .description = "Viscosity parameter (dashpot) of "
                                                                 "the terminal unit.",
                                                  .store = in_struct(&ReducedLungParameters::
                                                          LungTree::TerminalUnits::
                                                              RheologicalModel::KelvinVoigt::
                                      ...
                                      },
                                      {
                                          ...
                                          .required = false,
                                          .store = in_struct(&ReducedLungParameters::LungTree::
                                                  TerminalUnits::RheologicalModel::kelvin_voigt),
                                      }),
                                  group<ReducedLungParameters::LungTree::TerminalUnits::
                                          RheologicalModel::FourElementMaxwell>("4_element_maxwell",
                                      {
                                          input_field<double>("viscosity_kelvin_voigt_eta",
                                              {
                                                  .description =
                                                      "Dashpot viscosity of the Kelvin-Voigt body "
                                                      "of the terminal unit.",
                                                  .store = in_struct(&ReducedLungParameters::
                                                          LungTree::TerminalUnits::
                                                              RheologicalModel::FourElementMaxwell::
                                                                  viscosity_kelvin_voigt_eta),
                                              }),
                                          input_field<double>("viscosity_maxwell_eta_m",
                                              {
                                                  .description = "Dashpot viscosity of the Maxwell "
                                                                 "body of the terminal unit.",
                                                  .store = in_struct(&ReducedLungParameters::
                                                          LungTree::TerminalUnits::
                                                              RheologicalModel::FourElementMaxwell::
                                                                  viscosity_maxwell_eta_m),
                                              }),
                              ...
                              },
                              {
                                  ...
                                  .store = in_struct(&ReducedLungParameters::LungTree::
                                          TerminalUnits::rheological_model),
                              }),
                          group<ReducedLungParameters::LungTree::TerminalUnits::ElasticityModel>(
                              "elasticity_model",
                              {
                                  input_field<ReducedLungParameters::LungTree::TerminalUnits::
                                          ElasticityModel::ElasticityModelType>(
                                  ...
                                  group<ReducedLungParameters::LungTree::TerminalUnits::
                                          ElasticityModel::Linear>("linear",
                                      {
                                          input_field<double>("elasticity_e",
                                              {
                                                  .description = "Linear elastic stiffness of the "
                                                                 "terminal unit.",
                                                  .store = in_struct(&ReducedLungParameters::
                                                          LungTree::TerminalUnits::ElasticityModel::
                                                              Linear::elasticity_e),
                                              }),
                                      },
                                      {
                                          ...
                                          .required = false,
                                          .store = in_struct(&ReducedLungParameters::LungTree::
                                                  TerminalUnits::ElasticityModel::linear),
                                      }),
                                  group<ReducedLungParameters::LungTree::TerminalUnits::
                                          ElasticityModel::Ogden>("ogden",
                                      {
                                          ...
                                          input_field<double>("ogden_parameter_beta",
                                              {
                                                  ...
                                                  .store = in_struct(&ReducedLungParameters::
                                                          LungTree::TerminalUnits::ElasticityModel::
                                                              Ogden::ogden_parameter_beta),
                                              }),
                                      },
                                      {
                                          .description =
                                              "Ogden type spring in the rheological model "
                                              "of the terminal unit.",
                                          .required = false,
                                          .store = in_struct(&ReducedLungParameters::LungTree::
                                                  TerminalUnits::ElasticityModel::ogden),
                                      }),
                              },
                              {
                                  .description =
                                      "Elasticity model for the customizable spring of the "
                                      "rheological model.",
                                  .store = in_struct(&ReducedLungParameters::LungTree::
                                          TerminalUnits::elasticity_model),
                              }),
                      },
                      {
