...
// int condid_)
{
  ...
  Core::LinAlg::Matrix<(dim), 1> c_cnd(Core::LinAlg::Initialization::set_zero);

  // define the vector between center-of-mass and border-node
  Core::LinAlg::Matrix<(dim), 1> c_bnd(Core::LinAlg::Initialization::set_zero);

  // define the vector that is the nearest from right
  Core::LinAlg::Matrix<(dim), 1> v_right(Core::LinAlg::Initialization::set_zero);

  // define the vector that is the nearest from left
  Core::LinAlg::Matrix<(dim), 1> v_left(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<(dim), 1> dir_vec(Core::LinAlg::Initialization::set_zero);
