  ...
  if (ldconds.size())
  {
        ...
        labelit != ldnodemap.end(); ++labelit)
    {
          ...
          actnode != nodes.end(); ++actnode)
      {
        ...
        // get nodal forces
        Core::LinAlg::Matrix<3, 1> actforces(Core::LinAlg::Initialization::set_zero);
        ...
        // get moment
        Core::LinAlg::Matrix<3, 1> actmoments(Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<3, 1> actmoment_gc(Core::LinAlg::Initialization::set_zero);
        actmoment_gc(0, 0) =
