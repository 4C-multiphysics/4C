    ...
    else
    {
               ...
               (coupling == "meantangentialvelocityscaled"))
      {
        ...
        for (int gIdNode : gIdNodes)
        {
          ...
          Core::LinAlg::Matrix<2, 3> A(Core::LinAlg::Initialization::set_zero);
          ...
          Core::LinAlg::Matrix<2, 1> b(Core::LinAlg::Initialization::set_zero);
          ...
          // t])
          Core::LinAlg::Matrix<2, 2> matTimesMatTransposed(Core::LinAlg::Initialization::set_zero);
          ...
          Core::LinAlg::Matrix<3, 2> pInvA(Core::LinAlg::Initialization::set_zero);
          pInvA.multiply_tn(A, inverseOfMatTimesmatTransposed);

          // Solve for grid velocities
          Core::LinAlg::Matrix<3, 1> sol(Core::LinAlg::Initialization::set_zero);
      ...
      else if (coupling == "sphereHeightFunction")
      {
        ...
        for (int gIdNode : gIdNodes)
        {
          ...
          Core::LinAlg::Matrix<3, 1> b(Core::LinAlg::Initialization::set_zero);
          b(0, 0) = 0.0;
          b(1, 0) = 0.0;
          b(2, 0) = velnpDotETheta;

          // Calculate inverse of A (always possible due to linear independent rows)
          Core::LinAlg::Matrix<3, 3> invA(Core::LinAlg::Initialization::set_zero);
          invA.invert(A);
