       ...
       public:
        ...
        VariableManagerStruct(
            ...
            : VariableManagerDecorator<nsd, nen>(varmanager),
              ndsvel_(ndsvel),
              ndsdisp_(ndsdisp),
              econvelnp_(Core::LinAlg::Initialization::set_zero),  // initialized to zero
              edispnp_(Core::LinAlg::Initialization::set_zero),    // initialized to zero
              divconvelint_(0.0),
              convelint_(Core::LinAlg::Initialization::set_zero),
              dispint_(Core::LinAlg::Initialization::set_zero) {};
