    ...
    const Core::LinAlg::Vector<double>& displacement_state_vector)
{
  ...
  for (unsigned int ibeamele = 0; ibeamele < num_beam_row_elements; ++ibeamele)
  {
    ...
    Core::LinAlg::Matrix<3, 1> interpolated_position(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> interpolated_position_priorpoint(
    ...
    const Core::LinAlg::Vector<double>& displacement_state_vector)
{
  ...
  for (unsigned int ibeamele = 0; ibeamele < num_beam_row_elements; ++ibeamele)
  {
    ...
    Core::LinAlg::Matrix<3, 1> dirvec(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 1> unit_base_vec(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Vector<double>& displacement_state_vector)
{
  ...
  Core::LinAlg::Matrix<3, 1> pos_node_1(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1> pos_node_2(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 2> box(Core::LinAlg::Initialization::set_zero);
  if (periodic_boundingbox_ != nullptr)
  {
  ...
  Core::LinAlg::Matrix<3, 1> xi_intersect(Core::LinAlg::Initialization::set_zero);
