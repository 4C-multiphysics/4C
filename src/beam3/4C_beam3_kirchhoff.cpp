...
void Discret::Elements::Beam3k::set_up_initial_rotations(const std::vector<double>& nodal_thetas)
{
  ...
  for (int i = 0; i < BEAM3K_COLLOCATION_POINTS; i++)
  {
    ...
    {
      Core::LinAlg::Matrix<4, 1> Q(Core::LinAlg::Initialization::set_zero);
    ...
    const std::vector<Core::LinAlg::Matrix<3, 1>>& xrefe, const bool secondinit)
{
  ...
  if (!isinit_ || secondinit)
  {
    ...
    Core::LinAlg::Matrix<3, 1> theta(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> theta_s(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 3> triad_mat(
        Core::LinAlg::Initialization::set_zero);  // material triad at gp
    ...
    for (unsigned int node = 0; node < BEAM3K_COLLOCATION_POINTS; node++)
    {
      ...
      {
        Core::LinAlg::Matrix<3, 3> G_aux(Core::LinAlg::Initialization::set_zero);
    ...
    for (int numgp = 0; numgp < gausspoints.nquad; numgp++)
    {
      ...
      Core::LinAlg::Matrix<3, 3> temp_triad(Core::LinAlg::Initialization::set_zero);
    ...
    const std::vector<Core::LinAlg::Matrix<3, 1>>& xrefe, const bool secondinit)
{
  ...
  if (!isinit_ || secondinit)
  {
    ...
    for (int colpt = 0; colpt < BEAM3K_COLLOCATION_POINTS; colpt++)
    {
      Core::LinAlg::Matrix<3, 3> Lambdabarref(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<3, 1> tangentref(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<3, 1> phivec(Core::LinAlg::Initialization::set_zero);
      for (int i = 0; i < 3; i++)
      {
    ...
    Core::LinAlg::Matrix<3, 1>& pos, const double& xi, const std::vector<double>& disp) const
{
   ...
   * vector (7th DoF) */
  Core::LinAlg::Matrix<12, 1> disp_totlag_centerline(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseMatrix& Ivar, const double& xi, const std::vector<double>& disp) const
{
  ...
  Core::LinAlg::Matrix<ndim, numdof, double> N(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, vpernode * nnodecl, double> N_i(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<ndim, numdof, double> N_s(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, vpernode * nnodecl, double> N_i_xi(
      Core::LinAlg::Initialization::set_zero);

  Core::LinAlg::Matrix<1, numdof, double> L(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, BEAM3K_COLLOCATION_POINTS, double> L_i(
      Core::LinAlg::Initialization::set_zero);


  Core::LinAlg::Matrix<numdof, 1, double> disp_totlag(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<numdof, ndim, double> v_theta_bar(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::SerialDenseVector& force) const
{
  ...
  Core::LinAlg::Matrix<ndim, ndim, double> S_of_moment(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<ndim, 1, double> g_1_cp(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseMatrix& Iinc, const double& xi, const std::vector<double>& disp) const
{
  ...
  Core::LinAlg::Matrix<3, numdof, double> auxmatrix(Core::LinAlg::Initialization::set_zero);
    ...
    bool add_reference_values) const
{
  ...
  else
  {
    ...
    Core::LinAlg::Matrix<3, 3, T> triad(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<6 * nnodecl + BEAM3K_COLLOCATION_POINTS, 1, T>& dofvec) const
{
  ...
  else
  {
    ...
    for (unsigned int node = 0; node < 2; ++node)  // loop over boundary nodes
    {
      ...
      Core::LinAlg::Matrix<3, 1> disptheta(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<3, 1> thetanew(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<4, 1> deltaQ(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<4, 1> Qnew(Core::LinAlg::Initialization::set_zero);
    ...
    std::vector<Core::LinAlg::Matrix<4, 1>>& Qref_new) const
{
  if (rotvec_ == false)
  {
    Core::LinAlg::Matrix<3, 1, T> tangent(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 3, T> triad_ref(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 3> triad_aux(Core::LinAlg::Initialization::set_zero);
    // Todo @grill: get rid of auxiliary matrix of different type
    Core::LinAlg::Matrix<3, 3, T> triad_aux2(Core::LinAlg::Initialization::set_zero);
    T alpha = 0.0;
    ...
    for (unsigned int node = 0; node < 2; ++node)
    {
      ...
      Core::LinAlg::Matrix<4, 1, T> Qref(Core::LinAlg::Initialization::set_zero);
    ...
    std::vector<Core::LinAlg::Matrix<4, 1>>& Qref_new) const
{
  ...
  Core::LinAlg::Matrix<1, 4, T> N_i_xi(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<ndim, 1, FAD>& position, int gausspoint_index)
{
  ...
  Core::LinAlg::Matrix<ndim, 1, FAD> delta_r_ost(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 1, T>& r_s, T abs_r_s) const
{
  ...
  Core::LinAlg::Matrix<3, 3, T> S_of_r_s(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 1, double>& r_s, double abs_r_s) const
{
  ...
  Core::LinAlg::Matrix<3, 3, double> S_of_r_s(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 1, double>& g_1_bar, double abs_r_s) const
{
  ...
  Core::LinAlg::Matrix<3, 3, double> S_of_g_1(Core::LinAlg::Initialization::set_zero);
  ...
  // *********** alternative 1 ************
  Core::LinAlg::Matrix<3, 3, double> g_1dyadicproduct_g_1_bar_T(
      Core::LinAlg::Initialization::set_zero);
    ...
    double lin_prefactor_vel) const
{
  ...
  // second summand
  Core::LinAlg::Matrix<3, 3, double> auxmatrix(Core::LinAlg::Initialization::set_zero);

  Core::LinAlg::Matrix<3, 3, double> spinmatrix(Core::LinAlg::Initialization::set_zero);
  Core::LargeRotations::computespin(spinmatrix, angular_velocity_material);

  auxmatrix.multiply(spinmatrix, C_rho);

  Core::LinAlg::Matrix<3, 1, double> C_rho_W(Core::LinAlg::Initialization::set_zero);
