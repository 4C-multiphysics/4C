...
*/
     ...
     private:
      ...
      {
        Core::LinAlg::Matrix<3, 3, T> triad_bar(Core::LinAlg::Initialization::set_zero);
          ...
          Core::LinAlg::Matrix<3, 1, T>& r_ss, Core::LinAlg::Matrix<3, 1, T>& kappacl) const
      {
        ...
        // cross-product r'xr''
        Core::LinAlg::Matrix<3, 1, T> Srsrss(Core::LinAlg::Initialization::set_zero);
      ...
      {
        Core::LinAlg::Matrix<1, 1, T> scalar_aux(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<3, 1, T> g1(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<3, 1, T> g2(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<3, 1, T> g3(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<3, 1, T> gref1(Core::LinAlg::Initialization::set_zero);
        T KR1 = 0.0;
      ...
      {
        Core::LinAlg::Matrix<3, 3, FAD> auxmatrix1(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<3, 1, FAD> auxvec1(Core::LinAlg::Initialization::set_zero);
