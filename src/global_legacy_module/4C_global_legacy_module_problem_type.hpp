...
#ifndef FOUR_C_GLOBAL_LEGACY_MODULE_PROBLEM_TYPE_HPP
#define FOUR_C_GLOBAL_LEGACY_MODULE_PROBLEM_TYPE_HPP
...
namespace Core
{
  ...
  enum class ProblemType
  {
    ...
    reduced_lung_1d_pipe_flow,  ///< new implementation of arterial network
