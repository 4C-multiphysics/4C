...
namespace Core
{
  inline const std::map<std::string, ProblemType>& string_to_problem_type_map()
  {
    ...
    if (string2prbtype.size() == 0)
    {
      ...
      string2prbtype["Reduced_Lung_1D_Pipe_Flow"] = Core::ProblemType::reduced_lung_1d_pipe_flow;
