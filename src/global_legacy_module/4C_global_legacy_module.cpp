...
namespace
{
  void register_par_object_types()
  {
    ...
    s << Core::Nodes::NodeType::instance().name() << " "
      ...
      << Discret::Elements::SolidPoroPressureVelocityBasedType<2>::instance().name() << " "
      << Discret::Elements::SolidPoroPressureVelocityBasedType<3>::instance().name() << " "
      << Discret::Elements::SolidPoroPressureVelocityBasedP1Type<2>::instance().name() << " "
      ...
      << Mat::SolidSuperpositionType::instance().name() << " "
