  ...
  namespace Utils
  {
        ...
        const Mortar::Element& ele, const double* xi, double* globcoord, int inttype)
    {
      ...
      switch (inttype)
      {
        ...
        case 2:
        {
          Core::LinAlg::Matrix<ndim - 1, n> deriv2(Core::LinAlg::Initialization::set_zero);
          switch (ndim)
          {
            case 2:
            {
        ...
        double* xi)                                     // local position  (output)
    {
      ...
      Core::LinAlg::Matrix<numnod, 1> funct(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<ndim, numnod> xref(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<ndim, ndim> xjm(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<ndim, numnod> deriv(Core::LinAlg::Initialization::set_zero);
