...
struct NextSideAlongRay
{
  ...
  bool same_normal(Cut::Side* s1, Cut::Side* s2, const Core::LinAlg::Matrix<3, 1>& cutpoint_xyz)
  {
    ...
    Core::LinAlg::Matrix<2, 1> rs(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 1> normal_1(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 1> normal_2(Core::LinAlg::Initialization::set_zero);
...
bool Cut::Element::position_by_angle(Point* p, Point* cutpoint, Side* s)
{
  ...
  Core::LinAlg::Matrix<3, 1> cut_point_xyz(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<2, 1> rs(
      Core::LinAlg::Initialization::set_zero);  // local coordinates of the cut-point w.r.t side

  Core::LinAlg::Matrix<3, 1> normal(Core::LinAlg::Initialization::set_zero);
  s->normal(rs, normal);  // outward pointing normal at cut-point

  Core::LinAlg::Matrix<3, 1> line_vec(Core::LinAlg::Initialization::set_zero);
  line_vec.update(
...
bool Cut::Element::is_orthogonal_side(Side* s, Point* p, Point* cutpoint)
{
  ...
  {
    Core::LinAlg::Matrix<3, 1> line(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> p_xyz(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> cut_point_xyz(Core::LinAlg::Initialization::set_zero);
