...
namespace Cut
{
  ...
  class ConcreteElement : public Element
  {
   public:
    ...
    {
      Core::LinAlg::Matrix<num_nodes_element, 1> funct(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<probdim, num_nodes_element> xyze(Core::LinAlg::Initialization::set_zero);
