    ...
    const Inpar::FLUID::InitialField initfield, const int startfuncno)
{
  ...
  else if (initfield == Inpar::FLUID::initfield_flame_vortex_interaction)
  {
    ...
    double pres = 0.0;
    Core::LinAlg::Matrix<nsd, 1> xyz(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<nsd, 1> xyz0_left(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<nsd, 1> xyz0_right(Core::LinAlg::Initialization::set_zero);
