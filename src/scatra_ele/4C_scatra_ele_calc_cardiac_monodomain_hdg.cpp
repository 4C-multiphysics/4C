    ...
    std::shared_ptr<std::vector<Core::LinAlg::SerialDenseMatrix>> difftensor)
{
  ...
  if (actmat->diffusion_at_ele_center())
  {
    ...
    Core::LinAlg::Matrix<probdim, probdim> diff(Core::LinAlg::Initialization::set_zero);
    ...
    std::shared_ptr<std::vector<Core::LinAlg::SerialDenseMatrix>> difftensor)
{
  ...
  else
  {
    ...
    Core::LinAlg::Matrix<probdim, 1> gp_coord(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseVector& ivecnp, Core::LinAlg::SerialDenseMatrix& ivecnpderiv)
{
  ...
  Core::LinAlg::Matrix<probdim, 1> mat_gp_coord(Core::LinAlg::Initialization::set_zero);
