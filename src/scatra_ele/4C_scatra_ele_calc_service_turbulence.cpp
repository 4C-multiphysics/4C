    ...
    const Core::Elements::Element* ele, Teuchos::ParameterList& params)
{
  ...
  Core::LinAlg::Matrix<nsd_, 1> convelint(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<nsd_, 1> gradphi(Core::LinAlg::Initialization::set_zero);
...
{
  double phi_hat2 = 0.0;
  Core::LinAlg::Matrix<9, nen_> ealphaijsc_hat(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<nsd_, nen_> ephi_hat(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, nen_> ephi2_hat(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, nen_> ephiexpression_hat(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<nsd_, nsd_> alphaijsc_hat(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<nsd_, 1> phi_hat(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, 1> phi2_hat(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<1, 1> phiexpression_hat(Core::LinAlg::Initialization::set_zero);
