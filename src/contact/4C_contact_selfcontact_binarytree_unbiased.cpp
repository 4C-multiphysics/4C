...
bool CONTACT::UnbiasedSelfBinaryTree::rough_check_ref_config(int ele1gid, int ele2gid)
{
  ...
  static Core::LinAlg::Matrix<2, 1> xicele1(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<3, 1> ele1coords(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<3, 1> ele1normal(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<2, 1> xicele2(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<3, 1> ele2coords(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<3, 1> ele1ele2vec(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<1, 1> scalarprod(Core::LinAlg::Initialization::set_zero);
