          ...
          group("parameters",
              {
                  ...
                  parameter<std::vector<double>>("magnet_position", {.size = 3}),
                  parameter<double>("dynamic_viscosity_fluid"),
                  parameter<double>("rotation_around_x_axis", {.default_value = 0.0}),
                  parameter<double>("rotation_around_y_axis", {.default_value = 0.0}),
...
void ScaTra::CylinderMagnetFunction::evaluate_vector(
    const std::span<const double, 3> x, double t, std::span<double, 3> values) const
{
...
std::vector<double> ScaTra::CylinderMagnetFunction::global_to_cylinder_coordinates(
...
std::vector<double> ScaTra::CylinderMagnetFunction::cylinder_to_global_coordinates(
...
std::vector<double> ScaTra::CylinderMagnetFunction::evaluate_magnetic_field(
    const std::span<const double, 3> x) const
{
...
std::vector<double> ScaTra::CylinderMagnetFunction::evaluate_magnetic_force(
    const std::span<const double, 3> x) const
{
  // magnet parameters
  const double radius_magnet = parameters_.magnet_radius;
