  ...
  class CylinderMagnetFunction : public Core::Utils::FunctionOfSpaceTime
  {
   public:
    ...
    void evaluate_vector(
        std::span<const double, 3> x, double t, std::span<double, 3> values) const override;
   ...
   private:
     ...
     */
    [[nodiscard]] std::vector<double> evaluate_magnetic_field(std::span<const double, 3> x) const;
     ...
     */
    [[nodiscard]] std::vector<double> evaluate_magnetic_force(std::span<const double, 3> x) const;
     ...
     */
    [[nodiscard]] std::vector<double> global_to_cylinder_coordinates(
     ...
     */
    [[nodiscard]] std::vector<double> cylinder_to_global_coordinates(
