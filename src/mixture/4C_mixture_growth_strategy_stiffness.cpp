...
{
  Core::LinAlg::Matrix<3, 3> iC(Core::LinAlg::Initialization::leave_uninitialized);
  iC.multiply_tn(F, F);
  iC.invert();

  Core::LinAlg::Matrix<6, 1> iC_stress(Core::LinAlg::Initialization::leave_uninitialized);
