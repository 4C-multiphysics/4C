    ...
    Core::LinAlg::SerialDenseVector& elevec3_epetra)
{
  ...
  switch (act)
  {
    ...
    case Core::Elements::struct_calc_energy:
    {
      ...
      Core::LinAlg::Matrix<numnod_, noddof_> xrefe(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<numnod_, noddof_> xcurr(Core::LinAlg::Initialization::set_zero);
      ...
      Core::LinAlg::Matrix<numdim_, numnod_> derivs(Core::LinAlg::Initialization::set_zero);
      ...
      for (int gp = 0; gp < intpoints_.nquad; ++gp)
      {
        ...
        Core::LinAlg::Matrix<numdim_, numnod_> derivs_ortho(Core::LinAlg::Initialization::set_zero);
        double G1G2_cn;
        Core::LinAlg::Matrix<noddof_, 1> dXds1(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<noddof_, 1> dXds2(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<noddof_, 1> dxds1(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<noddof_, 1> dxds2(Core::LinAlg::Initialization::set_zero);
        Core::LinAlg::Matrix<noddof_, noddof_> Q_localToGlobal(
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> defgrd_glob(Core::LinAlg::Initialization::set_zero);

        // surface deformation gradient in 3 dimensions in local coordinates
        Core::LinAlg::Matrix<noddof_, noddof_> defgrd_loc(Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> cauchygreen_loc(
            Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseMatrix* elemat1_epetra)
{
  ...
  Core::LinAlg::Matrix<numnod_, 1> shapefcts(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<numdim_, numnod_> derivs(Core::LinAlg::Initialization::set_zero);
  ...
  for (int gp = 0; gp < intpoints_.nquad; ++gp)
  {
    ...
    Core::LinAlg::Matrix<noddof_, 1> dxds1(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<noddof_, 1> dxds2(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<noddof_, noddof_> Q_localToGlobal(Core::LinAlg::Initialization::set_zero);

    mem_orthonormalbase(
        xrefe, xcurr, derivs, derivs_ortho, G1G2_cn, dXds1, dXds2, dxds1, dxds2, Q_localToGlobal);

    // determine cross product x,1 x x,2
    Core::LinAlg::Matrix<noddof_, 1> xcurr_cross(Core::LinAlg::Initialization::set_zero);
    ...
    // determine cross product X,1 x X,2
    Core::LinAlg::Matrix<noddof_, 1> xrefe_cross(Core::LinAlg::Initialization::set_zero);
    ...
    const Inpar::Solid::StrainType iostrain)              // strain output option
{
  ...
  for (int gp = 0; gp < intpoints_.nquad; ++gp)
  {
    ...
    // calculate three dimensional right cauchy-green strain tensor in orthonormal base
    Core::LinAlg::Matrix<noddof_, noddof_> cauchygreen_loc(Core::LinAlg::Initialization::set_zero);
    cauchygreen_loc.multiply_tn(1.0, defgrd_loc, defgrd_loc, 0.0);
    ...
    Core::LinAlg::Matrix<3, 1> pk2red_loc(Core::LinAlg::Initialization::set_zero);

    // material tangent matrix for plane stress
    Core::LinAlg::Matrix<3, 3> cmatred_loc(Core::LinAlg::Initialization::set_zero);
    ...
    if (material()->material_type() == Core::Materials::m_growthremodel_elasthyper)
    {
      ...
      Core::LinAlg::Matrix<noddof_, 1> gprefecoord(Core::LinAlg::Initialization::set_zero);
    ...
    {
      Core::LinAlg::Matrix<3, 3> pk2M_glob(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<6, 6> cmat_glob(Core::LinAlg::Initialization::set_zero);
      ...
      Core::LinAlg::Matrix<3, 3> pk2M_loc(Core::LinAlg::Initialization::set_zero);
      ...
      Core::LinAlg::Matrix<6, 6> cmat_loc(Core::LinAlg::Initialization::set_zero);
    ...
    if (stiffmatrix == nullptr && force != nullptr)
    {
      ...
      Core::LinAlg::Matrix<noddof_, numdof_> B_matrix(Core::LinAlg::Initialization::set_zero);
    ...
    if (stiffmatrix != nullptr && force != nullptr)
    {
      ...
      Core::LinAlg::Matrix<noddof_, numdof_> B_matrix(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<numdof_, numdof_> G_matrix(Core::LinAlg::Initialization::set_zero);
      double g_ij;
      ...
      Core::LinAlg::Matrix<numdof_, noddof_> temp(Core::LinAlg::Initialization::set_zero);
      temp.multiply_tn(1.0, B_matrix, cmatred_loc, 0.0);
      Core::LinAlg::Matrix<numdof_, numdof_> temp2(Core::LinAlg::Initialization::set_zero);
    ...
    switch (iostrain)
    {
      ...
      case Inpar::Solid::strain_gl:
      {
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> cauchygreen_glob(
            Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> glstrain_glob(
            Core::LinAlg::Initialization::set_zero);
      ...
      case Inpar::Solid::strain_ea:
      {
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> euler_almansi(
            Core::LinAlg::Initialization::set_zero);
      ...
      case Inpar::Solid::strain_log:
      {
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> prstr2(
            Core::LinAlg::Initialization::set_zero);  // squared principal stretches
        Core::LinAlg::Matrix<noddof_, 1> prstr(
            Core::LinAlg::Initialization::set_zero);  // principal stretch
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> lnv(Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> tempCG(Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> diffCG(Core::LinAlg::Initialization::set_zero);
    ...
    switch (iostress)
    {
      ...
      case Inpar::Solid::stress_2pk:
      {
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> pkstressM_local(
            Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> pkstress_glob(
            Core::LinAlg::Initialization::set_zero);
      ...
      case Inpar::Solid::stress_cauchy:
      {
        ...
        // 2nd Piola-Kirchhoff stress in tensor notation, plane stress meaning entries in 2i and i2
        // are zero for i=0,1,2
        Core::LinAlg::Matrix<noddof_, noddof_> pkstressM_loc(
            Core::LinAlg::Initialization::set_zero);
        ...
        Core::LinAlg::Matrix<noddof_, noddof_> cauchy_glob(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<noddof_, noddof_>& Q_localToGlobal) const
{
  ...
  Core::LinAlg::Matrix<noddof_, numdim_> G12(Core::LinAlg::Initialization::set_zero);
  G12.multiply_tt(1.0, xrefe, derivs, 0.0);

  // G1 and G2 Gruttmann1992 equation (43)
  Core::LinAlg::Matrix<noddof_, 1> G1(Core::LinAlg::Initialization::set_zero);
  G1(0) = G12(0, 0);
  G1(1) = G12(1, 0);
  G1(2) = G12(2, 0);

  Core::LinAlg::Matrix<noddof_, 1> G2(Core::LinAlg::Initialization::set_zero);
  G2(0) = G12(0, 1);
  G2(1) = G12(1, 1);
  G2(2) = G12(2, 1);

  // cross product G1xG2
  Core::LinAlg::Matrix<noddof_, 1> G1G2_cross(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<noddof_, 1> tn(Core::LinAlg::Initialization::set_zero);
  tn(0) = G1G2_cross(0) / G1G2_cn;
  tn(1) = G1G2_cross(1) / G1G2_cn;
  tn(2) = G1G2_cross(2) / G1G2_cn;

  Core::LinAlg::Matrix<noddof_, 1> t1(Core::LinAlg::Initialization::set_zero);
  t1(0) = G1(0) / G1_n;
  t1(1) = G1(1) / G1_n;
  t1(2) = G1(2) / G1_n;

  Core::LinAlg::Matrix<noddof_, 1> t2(Core::LinAlg::Initialization::set_zero);
  t2(0) = tn(1) * t1(2) - tn(2) * t1(1);
  t2(1) = tn(2) * t1(0) - tn(0) * t1(2);
  t2(2) = tn(0) * t1(1) - tn(1) * t1(0);

  Core::LinAlg::Matrix<noddof_, numdim_> t12(Core::LinAlg::Initialization::set_zero);
  t12(0, 0) = t1(0);
  t12(1, 0) = t1(1);
  t12(2, 0) = t1(2);
  t12(0, 1) = t2(0);
  ...
  Core::LinAlg::Matrix<noddof_, numdim_> dXds(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<noddof_, noddof_>& euler_almansi) const
{
  ...
  Core::LinAlg::Matrix<noddof_, noddof_> invdefgrd(Core::LinAlg::Initialization::set_zero);
