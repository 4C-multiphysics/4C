    ...
    Core::LinAlg::Matrix<3, 3>& plastic_deform_grad_result)
{
  ...
  while (!converged && (iteration_number++ < max_iterations))
  {
    ...
    else
    {
      ...
      Core::LinAlg::Matrix<1, 1> d_gamma_trial_1(Core::LinAlg::Initialization::set_zero);
      ...
      Core::LinAlg::Matrix<2, 1> d_gamma_trial_2(Core::LinAlg::Initialization::set_zero);
      ...
      Core::LinAlg::Matrix<12, 1> d_gamma_trial_12(Core::LinAlg::Initialization::set_zero);
      ...
      Core::LinAlg::Matrix<16, 1> d_gamma_trial_16(Core::LinAlg::Initialization::set_zero);
      ...
      for (int i = 0; i < def_system_count_; i++)
      {
        ...
        Core::LinAlg::Matrix<3, 3> second_pk_stress_perturbed(
    ...
    std::vector<double>& residuals_trial)
{
  ...
  // set up L_p_trial
  Core::LinAlg::Matrix<3, 3> plastic_velocity_grad_trial(Core::LinAlg::Initialization::set_zero);
  ...
  for (int i = 0; i < slip_system_count_; i++)
  {
    ...
    Core::LinAlg::Matrix<1, 1> resolved_shear_stress(Core::LinAlg::Initialization::set_zero);

    Core::LinAlg::Matrix<3, 1> TempVec(Core::LinAlg::Initialization::set_zero);
