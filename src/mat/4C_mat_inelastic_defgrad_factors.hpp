  ...
  class InelasticDefgradTransvIsotropElastViscoplast : public InelasticDefgradFactors
  {
   public:
    ...
    struct StateQuantities
    {
      ...
      Core::LinAlg::Matrix<3, 3> curr_CeM_{Core::LinAlg::Initialization::set_zero};

      //! isotropic stress factors
      Core::LinAlg::Matrix<3, 1> curr_gamma_{Core::LinAlg::Initialization::set_zero};

      //! isotropic constitutive tensor factors
      Core::LinAlg::Matrix<8, 1> curr_delta_{Core::LinAlg::Initialization::set_zero};

      //! elastic 2nd PK stress tensors (specifically only transversely-isotropic components)
      Core::LinAlg::Matrix<3, 3> curr_SeM_{Core::LinAlg::Initialization::set_zero};

      //! elastic stiffness tensor (specifically only transversely-isotropic components)
      Core::LinAlg::Matrix<6, 6> curr_dSedCe_{Core::LinAlg::Initialization::set_zero};

      //! deviatoric, symmetric part of the Mandel stress tensor
      Core::LinAlg::Matrix<3, 3> curr_Me_dev_sym_M_{Core::LinAlg::Initialization::set_zero};
      ...
      Core::LinAlg::Matrix<3, 3> curr_NpM_{Core::LinAlg::Initialization::set_zero};

      //! plastic stretching tensor
      Core::LinAlg::Matrix<3, 3> curr_dpM_{Core::LinAlg::Initialization::set_zero};

      //! plastic velocity gradient tensor
      Core::LinAlg::Matrix<3, 3> curr_lpM_{Core::LinAlg::Initialization::set_zero};

      //! plastic update tensor
      Core::LinAlg::Matrix<3, 3> curr_EpM_{Core::LinAlg::Initialization::set_zero};
    };
    ...
    struct StateQuantityDerivatives
    {
      ...
      Core::LinAlg::Matrix<6, 9> curr_dCediFin_{Core::LinAlg::Initialization::set_zero};
      ...
      Core::LinAlg::Matrix<6, 6> curr_dCedC_{Core::LinAlg::Initialization::set_zero};

      //! derivatives of the equivalent tensile stress w.r.t. the inverse inelastic deformation
      //! gradient (Voigt notation)
      Core::LinAlg::Matrix<1, 9> curr_dequiv_stress_diFin_{Core::LinAlg::Initialization::set_zero};
      //! derivatives of the equivalent tensile stress w.r.t. the right Cauchy-Green deformation
      //! tensor (Voigt stress form)
      Core::LinAlg::Matrix<1, 6> curr_dequiv_stress_dC_{Core::LinAlg::Initialization::set_zero};
      ...
      Core::LinAlg::Matrix<6, 9> curr_dMe_dev_sym_diFin_{Core::LinAlg::Initialization::set_zero};
      //! derivative of the deviatoric, symmetric part of the Mandel stress tensor w.r.t. the right
      //! Cauchy-Green deformation tensor (Voigt stress-stress form)
      Core::LinAlg::Matrix<6, 6> curr_dMe_dev_sym_dC_{Core::LinAlg::Initialization::set_zero};
   ...
   private:
    ...
    struct ConstMatTensors
    {
      ...
      Core::LinAlg::Matrix<3, 3> mm_{Core::LinAlg::Initialization::set_zero};
      //! deviatoric part \f$ \left( \boldsymbol{m} \otimes \boldsymbol{m}
      //! \right)_\text{dev}\f$
      Core::LinAlg::Matrix<3, 3> mm_dev_{Core::LinAlg::Initialization::set_zero};
      ...
      Core::LinAlg::Matrix<6, 6> mm_dyad_mm_{Core::LinAlg::Initialization::set_zero};
      ...
      Core::LinAlg::Matrix<6, 6> mm_dev_dyad_mm_{Core::LinAlg::Initialization::set_zero};
