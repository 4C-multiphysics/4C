  ...
  namespace PAR
  {
    ...
    class Fourier : public Core::Mat::PAR::Parameter
    {
     public:
      ...
      //! type of activation prescription of conductivity values
       ...
       * - Vector in the input file specifying a globally constant tensor
       * - Map retrieved from the pattern file path in the input file specifying an element
       *   discrete vector. The integer key refers to the element ids.
       */
