    ...
    Core::LinAlg::Matrix<6, 1>& stm, Core::LinAlg::Matrix<6, 1>& stm_dT, int gp)
{
  ...
  Core::LinAlg::Matrix<3, 3> cauchygreen(Core::LinAlg::Initialization::leave_uninitialized);
  cauchygreen.multiply_tn(defgrad, defgrad);
  Core::LinAlg::Matrix<3, 3> Cinv(Core::LinAlg::Initialization::leave_uninitialized);
  Cinv.invert(cauchygreen);
  Core::LinAlg::Matrix<6, 1> Cinv_vct(Core::LinAlg::Initialization::leave_uninitialized);
    ...
    Teuchos::ParameterList& params, int gp, int eleGID)
{
  ...
  Core::LinAlg::Matrix<6, 6> cmat_T(Core::LinAlg::Initialization::leave_uninitialized);
    ...
    const int eleGID)
{
  ...
  // f_{n+1} = F_{n+1} . (F_n)^-1
  Core::LinAlg::Matrix<3, 3> defgrddelta(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  Core::LinAlg::Matrix<3, 3> bebar_trial(Core::LinAlg::Initialization::leave_uninitialized);
  Core::LinAlg::Matrix<3, 3> tmp(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  Core::LinAlg::Matrix<3, 3> devtau(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  else
  {
    ...
    if (Dgamma != 0.0)
    {
      ...
      // N = F^{-1} . n . F^{-T}
      Core::LinAlg::Matrix<3, 3> N(Core::LinAlg::Initialization::leave_uninitialized);
      ...
      // dev (n^2)
      Core::LinAlg::Matrix<3, 3> devnsquare(Core::LinAlg::Initialization::leave_uninitialized);
      ...
      //                          + || s || / mubar . dev[N^2] ]
      Core::LinAlg::Matrix<3, 3> dDgamma_dg(Core::LinAlg::Initialization::leave_uninitialized);
      ...
      Core::LinAlg::Matrix<3, 3> thrplheat_kTd_matrix(
          Core::LinAlg::Initialization::leave_uninitialized);
      thrplheat_kTd_matrix.update(fac_thrpl_kTd, dDgamma_dg);
      // Voigt notation
      Core::LinAlg::Matrix<6, 1> thrplheat_kTd_vct(
          Core::LinAlg::Initialization::leave_uninitialized);
      ...
      Core::LinAlg::Matrix<3, 3> Cmat_kdT_matrix(Core::LinAlg::Initialization::leave_uninitialized);
      Cmat_kdT_matrix.update((-2.0 * mubar * dDgamma_dT), N);
      // Voigt notation
      Core::LinAlg::Matrix<6, 1> Cmat_kdT_vct(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  // get the temperature-dependent material tangent
  Core::LinAlg::Matrix<6, 1> ctemp(Core::LinAlg::Initialization::leave_uninitialized);
...
) const
{
  ...
  Core::LinAlg::Matrix<3, 3> RCG(Core::LinAlg::Initialization::leave_uninitialized);
    ...
    const double temperature, const Teuchos::ParameterList& params) const
{
  ...
  // calculate the right Cauchy Green (RCG) deformation tensor and its inverse
  Core::LinAlg::Matrix<3, 3> RCG_disturb(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  for (int i = 0; i < 3; ++i)
  {
    for (int k = 0; k < 3; ++k)
    {
      ...
      // use vector-notation
      Core::LinAlg::Matrix<6, 1> disturb_Cinv_vct(
          Core::LinAlg::Initialization::leave_uninitialized);
