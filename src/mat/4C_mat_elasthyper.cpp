...
{
  static Core::LinAlg::Matrix<6, 1> C_strain(Core::LinAlg::Initialization::set_zero);
  C_strain.clear();
    ...
    Core::LinAlg::Matrix<9, 1>* d2_cauchyndir_dF_dT)
{
  ...
  static Core::LinAlg::Matrix<3, 3> b(Core::LinAlg::Initialization::set_zero);
  b.multiply_nt(1.0, defgrd, defgrd, 0.0);
  static Core::LinAlg::Matrix<3, 1> bdn(Core::LinAlg::Initialization::set_zero);
  bdn.multiply(1.0, b, n, 0.0);
  static Core::LinAlg::Matrix<3, 1> bddir(Core::LinAlg::Initialization::set_zero);
  bddir.multiply(1.0, b, dir, 0.0);
  const double bdnddir = bdn.dot(dir);

  static Core::LinAlg::Matrix<3, 3> ib(Core::LinAlg::Initialization::set_zero);
  ib.invert(b);
  static Core::LinAlg::Matrix<3, 1> ibdn(Core::LinAlg::Initialization::set_zero);
  ibdn.multiply(1.0, ib, n, 0.0);
  static Core::LinAlg::Matrix<3, 1> ibddir(Core::LinAlg::Initialization::set_zero);
  ibddir.multiply(1.0, ib, dir, 0.0);
  const double ibdnddir = ibdn.dot(dir);
  const double nddir = n.dot(dir);

  static Core::LinAlg::Matrix<6, 1> bV_strain(Core::LinAlg::Initialization::set_zero);
  ...
  static Core::LinAlg::Matrix<10, 1> dddPIII(Core::LinAlg::Initialization::set_zero);
  dPI.clear();
  ddPII.clear();
  dddPIII.clear();
  ...
  static Core::LinAlg::Matrix<9, 1> FV(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Voigt::matrix_3x3_to_9x1(defgrd, FV);
  static Core::LinAlg::Matrix<3, 3> iF(Core::LinAlg::Initialization::set_zero);
  iF.invert(defgrd);
  static Core::LinAlg::Matrix<3, 3> iFT(Core::LinAlg::Initialization::set_zero);
  iFT.update_t(iF);
  static Core::LinAlg::Matrix<9, 1> iFTV(Core::LinAlg::Initialization::set_zero);
  ...
  static Core::LinAlg::Matrix<3, 3> bdF(Core::LinAlg::Initialization::set_zero);
  bdF.multiply(1.0, b, defgrd, 0.0);
  static Core::LinAlg::Matrix<9, 1> bdFV(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Voigt::matrix_3x3_to_9x1(bdF, bdFV);
  static Core::LinAlg::Matrix<3, 3> ibdF(Core::LinAlg::Initialization::set_zero);
  ibdF.multiply(1.0, ib, defgrd, 0.0);
  static Core::LinAlg::Matrix<9, 1> ibdFV(Core::LinAlg::Initialization::set_zero);
  ...
  static Core::LinAlg::Matrix<3, 1> tempvec3x1(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<1, 3> tempvec1x3(Core::LinAlg::Initialization::set_zero);
  tempvec1x3.multiply_tn(1.0, dir, defgrd, 0.0);
  static Core::LinAlg::Matrix<3, 3> d_bdnddir_dF(Core::LinAlg::Initialization::set_zero);
  ...
  static Core::LinAlg::Matrix<9, 1> d_bdnddir_dFV(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Voigt::matrix_3x3_to_9x1(d_bdnddir_dF, d_bdnddir_dFV);

  // calculate d(b^{-1} \cdot n \cdot t)/dF
  static Core::LinAlg::Matrix<1, 3> dirdibdF(Core::LinAlg::Initialization::set_zero);
  static Core::LinAlg::Matrix<1, 3> ndibdF(Core::LinAlg::Initialization::set_zero);
  dirdibdF.multiply_tn(1.0, dir, ibdF, 0.0);
  static Core::LinAlg::Matrix<3, 3> d_ibdnddir_dF(Core::LinAlg::Initialization::set_zero);
  ...
  static Core::LinAlg::Matrix<9, 1> d_ibdnddir_dFV(Core::LinAlg::Initialization::set_zero);
  ...
  if (d2_cauchyndir_dF2 != nullptr)
  {
    ...
    static Core::LinAlg::Matrix<9, 9> d_iFT_dF(Core::LinAlg::Initialization::set_zero);
    static Core::LinAlg::Matrix<9, 9> d2_bdnddir_dF2(Core::LinAlg::Initialization::set_zero);
    static Core::LinAlg::Matrix<9, 9> d2_ibdnddir_dF2(Core::LinAlg::Initialization::set_zero);
    static Core::LinAlg::Matrix<9, 9> d2_I1_dF2(Core::LinAlg::Initialization::set_zero);
    static Core::LinAlg::Matrix<9, 9> d2_I2_dF2(Core::LinAlg::Initialization::set_zero);
    static Core::LinAlg::Matrix<9, 9> d2_I3_dF2(Core::LinAlg::Initialization::set_zero);
    d_iFT_dF.clear();
