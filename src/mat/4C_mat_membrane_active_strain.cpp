    ...
    Core::LinAlg::Matrix<3, 3>& cmat, const int gp, const int eleGID)
{
  ...
  Core::LinAlg::Matrix<3, 3> structuraltensor(Core::LinAlg::Initialization::set_zero);
  ...
  //******************
  Core::LinAlg::Matrix<3, 3> defgrd_active_inv_loc(Core::LinAlg::Initialization::set_zero);
  ...
  //******************
  Core::LinAlg::Matrix<3, 3> cauchygreen_passive_local(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 3> defgrd_passive_local(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3> cmatpassive_loc(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 1> S_passive_loc_voigt(Core::LinAlg::Initialization::set_zero);
  ...
  // FULL PART
  //******************
  Core::LinAlg::Matrix<2, 2> S_tot(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<2, 2> S_passive_loc(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<2, 2> defgrd_active_inv_loc_red(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<2, 2> temp2(Core::LinAlg::Initialization::set_zero);
