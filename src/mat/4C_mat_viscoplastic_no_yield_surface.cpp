    ...
    const int eleGID)
{
  ...
  // identity matrix
  static Core::LinAlg::Matrix<3, 3> id2(Core::LinAlg::Initialization::set_zero);
...
{
  static Core::LinAlg::Matrix<3, 3> scaledEigenvalues(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 1>& eigen_values) const
{
  ...
  static Core::LinAlg::Matrix<6, 1> Ee_trial_Vstrain;
  static Core::LinAlg::Matrix<3, 3> tmp3x3;
  static Core::LinAlg::Matrix<3, 3> logEigenValues(Core::LinAlg::Initialization::set_zero);
    ...
    const Core::LinAlg::Matrix<3, 1>& eigen_values) const
{
  static Core::LinAlg::Matrix<3, 3> Re_trial;
  static Core::LinAlg::Matrix<3, 3> tmp3x3;
  static Core::LinAlg::Matrix<3, 3> invEigenValues(Core::LinAlg::Initialization::set_zero);
