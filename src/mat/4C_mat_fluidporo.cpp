  ...
  class PoroConstantMaterialTransverseIsotropyStrategy : public PoroAnisotropyStrategyBase
  {
   public:
        ...
        [[maybe_unused]] const std::vector<double>& anisotropic_permeability_coeffs) const
    {
      ...
      Core::LinAlg::Matrix<dim, dim> permeability_tensor(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<dim, dim> structure_tensor(Core::LinAlg::Initialization::set_zero);
  ...
  class PoroConstantMaterialOrthotropyStrategy : public PoroAnisotropyStrategyBase
  {
   public:
        ...
        [[maybe_unused]] const std::vector<double>& anisotropic_permeability_coeffs) const override
    {
      ...
      Core::LinAlg::Matrix<3, 3> permeability_tensor(Core::LinAlg::Initialization::set_zero);
      Core::LinAlg::Matrix<3, 3> structure_tensor(Core::LinAlg::Initialization::set_zero);
