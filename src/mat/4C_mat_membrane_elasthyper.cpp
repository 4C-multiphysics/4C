    ...
    Core::LinAlg::Matrix<3, 3>& cmat, const int gp, const int eleGID)
{
  ...
  Core::LinAlg::Matrix<3, 1> stress_iso(Core::LinAlg::Initialization::set_zero);
  Core::LinAlg::Matrix<3, 3> cmat_iso(Core::LinAlg::Initialization::set_zero);
  ...
  {
    Core::LinAlg::Matrix<3, 1> stress_aniso(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 3> cmat_aniso(Core::LinAlg::Initialization::set_zero);
    ...
    const double& rcg33, Teuchos::ParameterList& params, const int gp, int eleGID)
{
  ...
  for (unsigned int p = 0; p < potsum_.size(); ++p)
  {
    ...
    Core::LinAlg::Matrix<3, 1> fibervector(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<6, 1> rcg_full(Core::LinAlg::Initialization::set_zero);
    rcg_full(0) = rcg(0);
    rcg_full(1) = rcg(1);
    rcg_full(2) = rcg33;
    ...
    Core::LinAlg::Matrix<6, 1> stress_aniso_full(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<6, 6> cmat_aniso_full(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 1> stress_aniso_red(Core::LinAlg::Initialization::set_zero);
    stress_aniso_red(0) = stress_aniso_full(0);
    stress_aniso_red(1) = stress_aniso_full(1);
    stress_aniso_red(2) = stress_aniso_full(3);

    Core::LinAlg::Matrix<3, 3> cmat_aniso_red(Core::LinAlg::Initialization::set_zero);
