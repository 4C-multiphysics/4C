...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<3, 3> NN(Core::LinAlg::Initialization::set_zero);
  ...
  {
    Core::LinAlg::Matrix<6, 6> dCdCv(Core::LinAlg::Initialization::set_zero);
      ...
      const Core::LinAlg::Matrix<3, 3>& C, const Core::LinAlg::FourTensor<3>& dCdC)
  {
    ...
    Core::LinAlg::Matrix<3, 3> Ce(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<6, 6> dCedCv(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 3> invCe(Core::LinAlg::Initialization::set_zero);
    invCe.invert(Ce);
    Core::LinAlg::Matrix<6, 1> invCev(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Voigt::Stresses::matrix_to_vector(invCe, invCev);

    // product invCe*L
    Core::LinAlg::Matrix<3, 3> invCeL(Core::LinAlg::Initialization::set_zero);
    invCeL.multiply_nn(invCe, L);

    // product invCe*L*invCe
    Core::LinAlg::Matrix<3, 3> invCeLinvCe(Core::LinAlg::Initialization::set_zero);
    invCeLinvCe.multiply_nn(invCeL, invCe);
    Core::LinAlg::Matrix<6, 1> invCeLinvCev(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Voigt::Stresses::matrix_to_vector(invCeLinvCe, invCeLinvCev);

    // product Ce^T*L
    Core::LinAlg::Matrix<3, 3> transpCeL(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 3> Se(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<6, 6> dSedCev(Core::LinAlg::Initialization::set_zero);
    ...
    const int eleGID)
{
  ...
  Core::LinAlg::Matrix<3, 3> invC(Core::LinAlg::Initialization::set_zero);   // matrix notation
  invC.invert(C);                                                            // invC = C^-1
  Core::LinAlg::Matrix<6, 1> invCv(Core::LinAlg::Initialization::set_zero);  // Voigt notation
  ...
  Core::LinAlg::Matrix<6, 1> dlambdaMdCv(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3> S1(Core::LinAlg::Initialization::set_zero);
  multiply_nnn(S1, detFa, invFa, Se_dSedC.Se, invFa);
  Core::LinAlg::Matrix<6, 1> S1v(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3> CinvFadFadomegaa(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<6, 6> cmat1v(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<6, 6> cmat2v(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<3, 3> H(Core::LinAlg::Initialization::set_zero);
  H.multiply_nn(dinvFadomegaa, dFadomegaa);
  H.multiply_nn(1.0, invFa, ddFaddomegaa, 1.0);
  Core::LinAlg::Matrix<3, 3> CH(Core::LinAlg::Initialization::set_zero);
  CH.multiply_nn(C, H);
  ...
  Core::LinAlg::Matrix<6, 1> dscalardCv(Core::LinAlg::Initialization::set_zero);
  ...
  Core::LinAlg::Matrix<6, 6> cmatvolv(Core::LinAlg::Initialization::set_zero);
...
{
  // inverse of active deformation gradient Fa^{-1}
  Core::LinAlg::Matrix<3, 3> invFa(Core::LinAlg::Initialization::set_zero);
  invFa.invert(Fa);
  return invFa;
}
    ...
    const Core::LinAlg::Matrix<3, 3>& Fa, const Core::LinAlg::Matrix<3, 3>& dFadomegaa)
{
  ...
  Core::LinAlg::Matrix<3, 3> dinvFadomegaa(Core::LinAlg::Initialization::set_zero);
