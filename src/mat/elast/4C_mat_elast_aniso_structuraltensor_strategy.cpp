    ...
    Core::LinAlg::Matrix<6, 1>& structural_tensor_stress)
{
  ...
  {
    // base vectors
    Core::LinAlg::Matrix<3, 1> e1(Core::LinAlg::Initialization::set_zero);
    e1(0) = 1.0;
    Core::LinAlg::Matrix<3, 1> e2(Core::LinAlg::Initialization::set_zero);
    e2(1) = 1.0;
    Core::LinAlg::Matrix<3, 1> e3(Core::LinAlg::Initialization::set_zero);
    e3(2) = 1.0;
    ...
    Core::LinAlg::Matrix<3, 3> rotation1(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 3> rotation2(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 3> rotation(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 3> temp(Core::LinAlg::Initialization::set_zero);
