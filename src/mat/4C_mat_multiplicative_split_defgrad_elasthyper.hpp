                                               ...
                                               public MonolithicSolidScalarMaterial
  {
   public:
    ...
    struct KinematicQuantities
    {
      ...
      Core::LinAlg::Matrix<3, 3> iCinCM{Core::LinAlg::Initialization::set_zero};
      ///\f$ \mathbf{F}_\text{in}^{-1} \cdot \mathbf{C}_\text{el} \f$
      Core::LinAlg::Matrix<3, 3> iFinCeM{Core::LinAlg::Initialization::set_zero};
      /// \f$ \mathbf{C} \cdot \mathbf{F}_\text{in}^{-1} \f$ stored as 9x1 vector
      Core::LinAlg::Matrix<9, 1> CiFin9x1{Core::LinAlg::Initialization::set_zero};
      ...
      Core::LinAlg::Matrix<6, 6> dCedC{Core::LinAlg::Initialization::set_zero};
      ...
      Core::LinAlg::Matrix<6, 9> dCediFin{Core::LinAlg::Initialization::set_zero};
    ...
    struct StressFactors
    {
      ...
      Core::LinAlg::Matrix<8, 1> delta{Core::LinAlg::Initialization::set_zero};
    };
