    ...
    Core::LinAlg::SerialDenseVector& elevec3)
{
  ...
  switch (act)
  {
    ...
    case Core::Elements::struct_calc_nlnstiff:
    {
      ...
      Core::LinAlg::Matrix<9, 1> weights(Core::LinAlg::Initialization::set_zero);
      ...
      Core::LinAlg::Matrix<9, 3, double> XI(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::SerialDenseMatrix* elemat1)
{
  ...
  {
    Core::LinAlg::Matrix<3, 1> force(Core::LinAlg::Initialization::set_zero);
