...
namespace
{
  ...
  TEST_F(UtilsRefConfigTest, LocalToGlobalPositionAtXiRefConfig)
  {
    ...
    Core::LinAlg::Matrix<3, 1> xicenterhex8ele(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> hex8elecoords(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> hex8refsolution(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<2, 1> xicenterquad4ele(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> quad4elecoords(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> quad4refsolution(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<3, 1> xicentertet4ele(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> tet4elecoords(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> tet4refsolution(Core::LinAlg::Initialization::set_zero);
    ...
    Core::LinAlg::Matrix<2, 1> xicentertri3ele(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> tri3elecoords(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> tri3refsolution(Core::LinAlg::Initialization::set_zero);
