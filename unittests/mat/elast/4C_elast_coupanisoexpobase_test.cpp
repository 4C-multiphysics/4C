...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<2, 1> dPIaniso(Core::LinAlg::Initialization::set_zero);
  ...
  {
    Core::LinAlg::Matrix<3, 1> ddPIaniso(Core::LinAlg::Initialization::set_zero);
  ...
  TEST_F(CoupAnisoExpoBaseTest, GetDerivativesAniso)
  {
    Core::LinAlg::Matrix<2, 1> dPIaniso(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<3, 1> ddPIaniso(Core::LinAlg::Initialization::set_zero);
    Core::LinAlg::Matrix<4, 1> dddPIaniso(Core::LinAlg::Initialization::set_zero);
