...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<3, 3> CeM_target(Core::LinAlg::Initialization::leave_uninitialized);
    ...
    Core::LinAlg::Matrix<3, 3> CeM(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<3, 3> iCinCiCinM_target(Core::LinAlg::Initialization::leave_uninitialized);
    ...
    Core::LinAlg::Matrix<3, 3> iCinCiCinM(Core::LinAlg::Initialization::leave_uninitialized);
