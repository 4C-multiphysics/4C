...
namespace
{
  ...
  {
    Core::LinAlg::Matrix<3, 3> sym_tensor(Core::LinAlg::Initialization::leave_uninitialized);
    sym_tensor(0, 0) = 1.1;
    sym_tensor(1, 1) = 1.2;
    sym_tensor(2, 2) = 1.3;
    ...
    Core::LinAlg::Matrix<3, 1> prinv_reference(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  {
    Core::LinAlg::Matrix<6, 1> A(Core::LinAlg::Initialization::leave_uninitialized);
    A(0) = 0.5;
    A(1) = 0.3;
    A(2) = 0.6;
    A(3) = 0.2;
    ...
    Core::LinAlg::Matrix<6, 1> InvABInvB(Core::LinAlg::Initialization::leave_uninitialized);
    InvABInvB(0) = 1.72;
    InvABInvB(1) = 1.65;
    InvABInvB(2) = 1.13;
    InvABInvB(3) = 1.27;
    ...
    Core::LinAlg::Matrix<6, 6> Result_reference(Core::LinAlg::Initialization::leave_uninitialized);
  ...
  TEST(MaterialServiceTest, TestComputeJ2)
  {
    ...
    Core::LinAlg::Matrix<3, 3> stress(Core::LinAlg::Initialization::leave_uninitialized);
    stress(0, 0) = 1.0;
    stress(1, 1) = 2.0;
    stress(2, 2) = 3.0;
  ...
  TEST(MaterialServiceTest, TestDeviatoricTensor)
  {
    ...
    Core::LinAlg::Matrix<3, 3> s_ref(Core::LinAlg::Initialization::leave_uninitialized);
    s_ref(0, 0) = -1.0;
    s_ref(1, 1) = 0.0;
    s_ref(2, 2) = 1.0;
  ...
  TEST(MaterialServiceTest, TestADBCProduct)
  {
    ...
    Core::LinAlg::Matrix<3, 3> x(Core::LinAlg::Initialization::leave_uninitialized);
    x(0, 0) = 1.0000000000;
    x(0, 1) = 2.0000000000;
    x(0, 2) = 3.0000000000;
    x(1, 0) = 0.0000000000;
    ...
    Core::LinAlg::Matrix<3, 3> y(Core::LinAlg::Initialization::leave_uninitialized);
    y(0, 0) = 1.0000000000;
    y(0, 1) = 0.0000000000;
    y(0, 2) = 5.0000000000;
    y(1, 0) = 0.0000000000;
