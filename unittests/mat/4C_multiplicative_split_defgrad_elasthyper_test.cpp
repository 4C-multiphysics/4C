...
namespace
{
  ...
  TEST_F(MultiplicativeSplitDefgradElastHyperTest, TestEvaluateLinearizationOD)
  {
    ...
    const double concentration(1.0);
    Core::LinAlg::Matrix<9, 1> DFDx(Core::LinAlg::Initialization::set_zero);
  ...
  TEST_F(MultiplicativeSplitDefgradElastHyperTest, TestEvaluateOdStiffMat)
  {
    ...
    Core::LinAlg::Matrix<6, 1> dSdx(Core::LinAlg::Initialization::set_zero);
    // reference solution
  ...
  TEST_F(MultiplicativeSplitDefgradElastHyperTest, TestEvaluateStressCmatIso)
  {
    ...
    Core::LinAlg::Matrix<6, 1> S(Core::LinAlg::Initialization::set_zero);
    // reference solution
    Core::LinAlg::Matrix<6, 1> S_ref(Core::LinAlg::Initialization::set_zero);
