...
namespace
{
  ...
  namespace
  {
    ...
    Discret::Elements::Stress<celltype> get_stress()
    {
      ...
      stress.cmat_ = Core::LinAlg::dyadic(Core::LinAlg::TensorGenerators::identity<double, 3, 3>,
  ...
  TYPED_TEST(SolidEleCalcLibTest, BFreeElementStiffnessMatrix)
  {
    ...
    add_geometric_stiffness_matrix(
        jacobian_mapping.N_XYZ_, stress, integration_factor, stiffness_matrix_bop);
